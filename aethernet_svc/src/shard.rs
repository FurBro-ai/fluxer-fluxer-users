...
mod tests {
    ...
    fn test_config(max_concurrent_requests: usize) -> ServiceConfig {
        ServiceConfig {
            ...
            scylla_keyspace: "aethernet".to_owned(),
            scylla_username: None,
            scylla_password: None,
            postgres_url: None,
            postgres_host: "127.0.0.1".to_owned(),
            postgres_port: 5432,
            postgres_database: "aethernet".to_owned(),
            postgres_username: "aethernet".to_owned(),
            postgres_password: Some("aethernet".to_owned()),
            postgres_ssl: false,
            postgres_ssl_ca: None,
            postgres_max_connections: 1,
            postgres_kv_table: "aethernet_kv".to_owned(),
