...
This repository mirrors static assets for AETHERNET. AETHERNET-owned assets are
...
by `aethernet_app` from `@sapphi-red/web-noise-suppressor` rather than mirrored
here; their licenses and build-time modification disclosure live with the code in
`aethernet_app/src/features/voice/utils/noise_suppression/NOTICE.md`.
...
No AETHERNET license notice grants rights to third-party trademarks or brand names.
