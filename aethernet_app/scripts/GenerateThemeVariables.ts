...
const SKELETON_SURFACE_INVARIANTS: ReadonlyArray<SkeletonSurfaceInvariant> = [
	...
	},
	{
		...
		requires: [
			...
			".item[data-selected='true'] .aethernetIcon",
			'clip-path: inset(0);',
	...
	},
	{
		...
		requiresPattern: ['<ChatCircleIcon[^>]*weight="fill"[^>]*className=\\{styles\\.aethernetIconGlyph\\}'],
	...
	{
		file: 'src/features/app/components/layout/sidebar_nav/AethernetButton.tsx',
		requires: [
