...
type AethernetDebugGlobal = Record<string, unknown> & AethernetDebugApi;

interface AethernetBootstrapGlobal {
	config: {
...
declare global {
	...
	interface Window {
		__AETHERNET_BOOTSTRAP__?: AethernetBootstrapGlobal;
		__AETHERNET_DEBUG__?: AethernetDebugGlobal;
