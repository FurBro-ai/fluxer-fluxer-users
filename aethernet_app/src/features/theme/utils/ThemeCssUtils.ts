...
export const THEME_ASSET_REFERENCE_PREFIX = 'aethernet-theme-asset';
export const THEME_LOCAL_FILE_REFERENCE_PREFIX = 'aethernet-local-file';
...
const ASSET_FUNCTION_PATTERN = /aethernet-theme-asset\(\s*(['"])(.*?)\1\s*\)/g;
const ASSET_URL_PATTERN = /url\(\s*(['"]?)aethernet-theme-asset:\/\/([^'")\s]+)\1\s*\)/g;
const LOCAL_FILE_FUNCTION_PATTERN = /aethernet-local-file\(\s*(['"])(.*?)\1\s*\)/g;
const LOCAL_FILE_URL_PATTERN = /url\(\s*(['"]?)aethernet-local-file:\/\/([^'")]+)\1\s*\)/g;
