...
const OPEN_DESKTOP_DOWNLOADS_DESCRIPTOR = msg({
	...
	comment: 'Button label that opens the AETHERNET desktop downloads page in a browser.',
});
...
export const RESTART_AETHERNET_DESCRIPTOR = msg({
					...
					<ConfirmModal
						...
						onPrimary={() => {
							const appstreamUrl = isCanaryDesktop()
								? 'appstream://app.aethernet.AethernetCanary'
								: 'appstream://app.aethernet.Aethernet';
	...
	ModalCommands.pushWithKey(
		modal(() => (
			<ConfirmModal
				...
				primaryText={i18n._(RESTART_AETHERNET_DESCRIPTOR, {productName: PRODUCT_NAME})}
				secondaryText={i18n._(LATER_DESCRIPTOR)}
				onPrimary={async () => {
					await onInstall();
				}}
