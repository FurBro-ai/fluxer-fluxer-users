...
const APPIMAGE_OPTION: UpdaterDownloadOption = {
	format: 'appimage',
	label: 'AppImage',
	url: 'https://api.aethernet.app/dl/desktop/stable/linux/x64/latest/appimage',
	suggestedName: 'Aethernet-1.2.3-linux-x86_64.AppImage',
	sha256: 'abc123',
};
...
const DEB_OPTION: UpdaterDownloadOption = {
	format: 'deb',
	label: 'DEB package',
	url: 'https://api.aethernet.app/dl/desktop/stable/linux/x64/latest/deb',
	suggestedName: 'Aethernet-1.2.3-linux-amd64.deb',
	sha256: 'def456',
};
