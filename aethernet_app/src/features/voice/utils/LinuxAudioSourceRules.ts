...
export const LINUX_AUDIO_TARGET_OBJECTS_PATTERN_KEY = 'aethernet.target.objects';
export const LINUX_AUDIO_DISPLAY_PATTERN_PREFIX = 'aethernet.display.';
export const LINUX_AUDIO_DISPLAY_NAME_PATTERN_KEY = 'aethernet.display.name';
export const LINUX_AUDIO_PRESERVE_VOLATILE_IDENTITY_PATTERN_KEY = 'aethernet.display.preserveVolatileIdentity';
