...
`aethernet_app/scripts/build/rspack/noise-suppressor-worklet-loader.cjs`, which
...
The Xiph license text ships inside `speex.wasm`'s worklet bundle. No Aethernet
