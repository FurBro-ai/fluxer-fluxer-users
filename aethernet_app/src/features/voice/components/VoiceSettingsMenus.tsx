...
import {AUTOMATIC_VOICE_REGION_ID} from '@aethernet/constants/src/ChannelConstants';
...
const AUTOMATIC_DESCRIPTOR = msg({
	message: 'Automatic',
	comment:
		'Voice region option label in the voice settings menu meaning let Aethernet pick the best region automatically.',
});
