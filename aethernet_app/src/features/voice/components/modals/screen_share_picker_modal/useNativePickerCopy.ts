...
const BROWSERS_DO_NOT_LET_LIST_APP_WINDOWS_AHEAD_DESCRIPTOR = msg({
	...
	comment: 'Empty-state explanation in the screen-share picker apps tab on web. {productName} is Aethernet.',
});
...
const BROWSERS_DO_NOT_LET_LIST_DISPLAYS_AHEAD_OF_DESCRIPTOR = msg({
	...
	comment: 'Empty-state explanation in the screen-share picker displays tab on web. {productName} is Aethernet.',
});
