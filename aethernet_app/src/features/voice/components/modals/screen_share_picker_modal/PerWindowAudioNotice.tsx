...
const WINDOWS_DESKTOP_AUDIO_UNSUPPORTED_TITLE_DESCRIPTOR = msg({
	...
	comment:
		'Inline notice on Windows when desktop/system audio capture is not supported because Aethernet cannot exclude call audio.',
});
...
const MACOS_DESKTOP_AUDIO_UNSUPPORTED_TITLE_DESCRIPTOR = msg({
	...
	comment:
		'Inline notice on macOS when desktop/system audio capture is not supported because Aethernet cannot exclude call audio.',
});
