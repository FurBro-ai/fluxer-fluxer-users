...
import type {VoiceEngineV2Model, VoiceEngineV2Snapshot} from '@aethernet/voice_engine_v2';
import {isVoiceEngineV2FrameReceivedEvent} from '@aethernet/voice_engine_v2/runtime';
