...
import type {TimerPort, VoiceEngineV2TimerOptions} from '@aethernet/voice_engine_v2';
import type {VoiceEngineV2ClockPort} from '@aethernet/voice_engine_v2/runtime';
