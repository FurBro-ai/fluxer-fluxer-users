...
import type {AethernetCodecAdvertisement} from '@app/features/voice/engine/ScreenShareCodecNegotiation';
...
function publisherThatEncodes(): Array<AethernetCodecAdvertisement> {
	return [
