...
const AUDIO_WORKLET_PROCESSOR_NAME = 'aethernet-native-engine-audio-track-pump';
...
class AethernetNativeEngineAudioTrackPumpProcessor extends AudioWorkletProcessor {
	constructor() {
		super();
		this.stopped = false;
...
registerProcessor('${AUDIO_WORKLET_PROCESSOR_NAME}', AethernetNativeEngineAudioTrackPumpProcessor);
`;
