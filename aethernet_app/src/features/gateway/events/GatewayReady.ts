...
import type {RtcRegionResponse, Channel as WireChannel} from '@aethernet/schema/src/domains/channel/ChannelSchemas';
import type {UserPrivate, User as WireUser} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
