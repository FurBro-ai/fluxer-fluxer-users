...
import {DEFAULT_API_VERSION, FAVORITES_GUILD_ID} from '@aethernet/constants/src/AppConstants';
import {GatewayIdentifyFlags} from '@aethernet/constants/src/GatewayConstants';
