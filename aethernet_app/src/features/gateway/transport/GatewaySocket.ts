...
import type {GatewayErrorCode} from '@aethernet/constants/src/GatewayConstants';
import {GatewayCloseCodes, GatewayOpcodes} from '@aethernet/constants/src/GatewayConstants';
