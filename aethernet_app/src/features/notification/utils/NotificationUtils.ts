...
type NotificationClickHandlerGlobal = typeof globalThis & {
	__aethernetNotificationClickHandlerInitialized?: boolean;
};

function hasInitializedDesktopNotificationClickHandler(): boolean {
	return Boolean((globalThis as NotificationClickHandlerGlobal).__aethernetNotificationClickHandlerInitialized);
}

function setDesktopNotificationClickHandlerInitialized(): void {
	(globalThis as NotificationClickHandlerGlobal).__aethernetNotificationClickHandlerInitialized = true;
}
