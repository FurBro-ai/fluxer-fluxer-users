...
import type {GuildEmoji as WireGuildEmoji} from '@aethernet/schema/src/domains/guild/GuildEmojiSchemas';
import type {Guild as WireGuild} from '@aethernet/schema/src/domains/guild/GuildResponseSchemas';
import {EmojiStateSchema} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/pickers_pb';
import {sortBySnowflakeDesc} from '@aethernet/snowflake/src/SnowflakeUtils';
