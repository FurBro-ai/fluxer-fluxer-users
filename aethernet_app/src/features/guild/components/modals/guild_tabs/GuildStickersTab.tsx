...
import {MAX_GUILD_STICKERS} from '@aethernet/constants/src/LimitConstants';
import type {GuildStickerWithUser} from '@aethernet/schema/src/domains/guild/GuildEmojiSchemas';
