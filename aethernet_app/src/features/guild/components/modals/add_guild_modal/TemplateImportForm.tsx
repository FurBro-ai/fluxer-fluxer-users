...
import {THE_OTHER_PLATFORM} from '@aethernet/constants/src/ExternalPlatformConstants';
...
import {
	...
	ModalFooterContext,
	mapTemplateChannelTypeToAethernet,
...
export const TemplateImportForm = observer(() => {
	...
	const templateStats = useMemo(() => {
		...
		const channelTypes = templateData.channels
			.map((channel) => mapTemplateChannelTypeToAethernet(channel.type))
