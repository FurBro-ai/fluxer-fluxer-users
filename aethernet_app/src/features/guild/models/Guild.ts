...
import {LARGE_GUILD_THRESHOLD} from '@aethernet/constants/src/GatewayConstants';
import type {GuildSplashCardAlignmentValue} from '@aethernet/constants/src/GuildConstants';
import {GuildFeatures, GuildNSFWLevel, GuildSplashCardAlignment} from '@aethernet/constants/src/GuildConstants';
import type {LimitKey} from '@aethernet/constants/src/LimitConfigMetadata';
import {MAX_GUILD_EMOJIS, MAX_GUILD_STICKERS} from '@aethernet/constants/src/LimitConstants';
import {MessageNotifications} from '@aethernet/constants/src/NotificationConstants';
import {resolveLimit} from '@aethernet/limits/src/LimitResolver';
import type {Guild as WireGuild} from '@aethernet/schema/src/domains/guild/GuildResponseSchemas';
import type {GuildRole as WireGuildRole} from '@aethernet/schema/src/domains/guild/GuildRoleSchemas';
