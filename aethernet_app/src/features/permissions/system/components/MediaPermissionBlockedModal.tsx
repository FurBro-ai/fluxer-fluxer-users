...
const MICROPHONE_DESKTOP_DESCRIPTOR = msg({
	...
	comment: 'Body of the microphone-permission-denied modal on Windows and Linux. {productName} is Aethernet.',
});
const MICROPHONE_WEB_DESCRIPTOR = msg({
	...
	comment: 'Body of the microphone-permission-denied modal on web. {productName} is Aethernet.',
});
const CAMERA_DESKTOP_DESCRIPTOR = msg({
	...
	comment: 'Body of the camera-permission-denied modal on Windows and Linux. {productName} is Aethernet.',
});
const CAMERA_WEB_DESCRIPTOR = msg({
	...
	comment: 'Body of the camera-permission-denied modal on web. {productName} is Aethernet.',
});
const SCREEN_DESCRIPTOR = msg({
	...
	comment: 'Body of the screen-permission-denied modal on non-mac desktop platforms. {productName} is Aethernet.',
});
