...
import {compareChannelOrdering} from '@aethernet/schema/src/domains/channel/GuildChannelOrdering';
...
const OFFICIAL_INVITE_URL_BASES = Object.freeze([
	'https://aethernet.app/invite',
	'https://canary.aethernet.app/invite',
	'https://web.aethernet.app/invite',
	'https://web.canary.aethernet.app/invite',
	'https://aethernet.gg',
	'https://aethernet.gg/invite',
]);
