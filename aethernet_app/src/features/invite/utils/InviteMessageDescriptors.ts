...
export const RAID_INVITES_PAUSED_DESCRIPTOR = msg({
	...
	comment:
		'Invite page notice shown when automated raid protection pauses invites. productName is the Aethernet product name.',
});
export const RAID_INVITES_PAUSED_SHORT_DESCRIPTOR = msg({
	...
	comment:
		'Invite modal notice shown when automated raid protection pauses invites. productName is the Aethernet product name.',
});
export const INVITES_PAUSED_BECAUSE_RAID_DESCRIPTOR = msg({
	...
	comment:
		'Invite settings notice shown when automated raid protection pauses invites. productName is the Aethernet product name.',
});
