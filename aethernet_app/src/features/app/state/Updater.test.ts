...
const REPORTED_DEB_DOWNLOAD = [
	...
	`Aethernet-Canary-${REPORTED_VERSION}-linux-amd64.deb`,
];
const NEWER_DEB_DOWNLOAD = [`${CANARY_X64}/${NEWER_VERSION}/deb`, `Aethernet-Canary-${NEWER_VERSION}-linux-amd64.deb`];
		...
		downloadOptions: [
			{
				...
				suggestedName: `Aethernet-Canary-${version}-linux-amd64.deb`,
				sha256: `deb-${version}`,
			},
		],
	});
