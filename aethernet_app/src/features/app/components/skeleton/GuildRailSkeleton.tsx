...
const FavoritesButtonPlaceholder = ({selected}: {readonly selected: boolean}) => (
	...
	>
		...
		<flx-app-guild-rail-skeleton-aethernet-icon
			className={flxElementClassName(styles.aethernetIcon)}
...
const AethernetButtonPlaceholder = ({selected}: {readonly selected: boolean}) => (
	<flx-app-guild-rail-skeleton-item
		className={flxElementClassName(styles.item)}
		data-selected={selectedAttribute(selected)}
		data-flx="app.skeleton.guild-rail-skeleton.aethernet-button-placeholder.item"
	>
		{selected && (
			<GuildRailSkeletonIndicator
				selected={true}
				data-flx="app.skeleton.guild-rail-skeleton.aethernet-button-placeholder.guild-rail-skeleton-indicator"
			/>
		)}
		<flx-app-guild-rail-skeleton-aethernet-icon
			className={flxElementClassName(styles.aethernetIcon)}
			data-flx="app.skeleton.guild-rail-skeleton.aethernet-button-placeholder.aethernet-icon"
		>
			<ChatCircleIcon
				weight="fill"
				className={styles.aethernetIconGlyph}
				data-flx="app.skeleton.guild-rail-skeleton.aethernet-button-placeholder.aethernet-icon-glyph"
			/>
		</flx-app-guild-rail-skeleton-aethernet-icon>
	</flx-app-guild-rail-skeleton-item>
);
...
interface GuildRailSkeletonProps {
	readonly isAethernetSelected: boolean;
...
export const GuildRailSkeleton: React.FC<GuildRailSkeletonProps> = ({
	...
	const aethernetVisible = rememberedLayout?.aethernetVisible ?? !RuntimeConfig.directMessagesDisabled;
	...
	const aethernetIsLastTopRow = aethernetVisible && !favoritesVisible && inlineDmRowCount === 0;
	...
	const topRowCount = (aethernetVisible ? 1 : 0) + (favoritesVisible ? 1 : 0) + inlineDmRowCount;
			...
			>
				...
				>
					<flx-app-guild-rail-skeleton-top-section
						className={flxElementClassName(styles.section, aethernetIsLastTopRow && styles.sectionTrailingGap)}
						data-flx="app.skeleton.guild-rail-skeleton.section"
					>
						{aethernetVisible && (
							<AethernetButtonPlaceholder
								selected={isAethernetSelected}
								data-flx="app.skeleton.guild-rail-skeleton.aethernet-button-placeholder"
							/>
						)}
						{favoritesVisible && (
