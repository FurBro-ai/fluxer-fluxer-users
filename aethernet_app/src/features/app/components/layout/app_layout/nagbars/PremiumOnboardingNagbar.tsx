...
const PREMIUM_ONBOARDING_DEFAULT_MESSAGE_DESCRIPTOR = msg({
	...
	comment:
		'Premium onboarding nagbar body. {premiumProductFullName} is the full premium product name, such as Aethernet Plutonium. {premiumProductName} is the short product name.',
});
