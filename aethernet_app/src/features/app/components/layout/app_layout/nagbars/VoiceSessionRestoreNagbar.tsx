...
const COMMUNITY_VOICE_SESSION_RESTORE_MESSAGE_DESCRIPTOR = msg({
	...
	comment:
		'Nagbar shown after the app restarts while the user was connected to a community voice channel. {productName} is Aethernet, {channelName} is the voice channel name, and {communityName} is the community name.',
});
const DIRECT_CALL_VOICE_SESSION_RESTORE_MESSAGE_DESCRIPTOR = msg({
	...
	comment:
		'Nagbar shown after the app restarts while the user can reconnect to an active DM or group DM call. {productName} is Aethernet and {directCallName} is the DM or group DM display name.',
});
