	...
	return (
		...
		>
			...
			>
				<button
					type="button"
					className={clsx(styles.aethernetButton, contextMenuOpen && styles.contextMenuHover, className)}
					...
					ref={mergedButtonRef}
					data-flx="app.sidebar-nav.favorites-button.aethernet-button.select"
				>
					...
					<div className={styles.relative} data-flx="app.sidebar-nav.favorites-button.relative">
						<motion.div
							...
							data-flx="app.sidebar-nav.favorites-button.aethernet-button-icon"
						>
							<StarIcon
								weight="fill"
