...
import {GuildFeatures, GuildMFALevel} from '@aethernet/constants/src/GuildConstants';
...
const INVITES_DISABLED_RAID_MESSAGE_DESCRIPTOR = msg({
	...
	comment:
		'Guild nagbar body shown when invite links are paused because raid detection is active. {communityName} is the community name and {productName} is Aethernet.',
});
...
const STAFF_ONLY_GUILD_MESSAGE_DESCRIPTOR = msg({
	...
	comment:
		'Guild nagbar body shown for staff-only communities. {communityName} is the community name and {productName} is Aethernet.',
});
