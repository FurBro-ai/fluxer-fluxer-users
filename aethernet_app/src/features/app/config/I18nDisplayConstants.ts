...
export const SUPPORT_EMAIL = 'support@aethernet.app';
export const SUPPORT_EMAIL_MAILTO = `mailto:${SUPPORT_EMAIL}`;
export const I18N_EMAIL = 'i18n@aethernet.app';
export const I18N_EMAIL_MAILTO = `mailto:${I18N_EMAIL}`;
export const I18N_WEBLATE_DOMAIN = 'weblate.aethernet.app';
...
export const EXAMPLE_AETHERNET_TAG = 'Marty_McFly';
...
export const EXAMPLE_AETHERNET_TAG_FULL = 'Username#0000';
export const AETHERNET_TAG_LABEL = 'AETHERNET Tag';
export const VISIONARY_LIFETIME_BADGE_LABEL = 'Visionary #42';
export const AETHERNET_TAG_MIN_WITH_ZERO_LABEL = '#0000';
export const AETHERNET_TAG_MIN_STANDARD_LABEL = '#0001';
export const AETHERNET_TAG_MAX_LABEL = '#9999';
export const LINK_PREVIEW_EXAMPLE_URL = 'https://aethernet.app';
...
export const DESKTOP_DOWNLOAD_URL =
	Config.PUBLIC_RELEASE_CHANNEL === 'canary'
		? 'https://canary.aethernet.app/download'
		: 'https://aethernet.app/download';
export const AETHERNET_DOCS_DOMAIN = 'docs.aethernet.app';
export const AETHERNET_DOCS_URL = `https://${AETHERNET_DOCS_DOMAIN}`;
export const AETHERNET_BLUESKY_HANDLE = '@aethernet.app';
export const SPLASH_IRC_SERVER = 'irc.aethernet.app:6667';
...
export const AETHERNET_TAG_DIGIT_COUNT = 4;
