...
import {AethernetLogo} from '@app/features/ui/components/icons/AethernetLogo';
import {AethernetWordmark} from '@app/features/ui/components/icons/AethernetWordmark';
			...
			>
				{showLogoSide && (
					<div className={authLayoutStyles.logoSide} data-flx="auth.flow.auth-card-container.div--3">
						<AethernetLogo className={authLayoutStyles.logo} data-flx="auth.flow.auth-card-container.aethernet-logo" />
						<AethernetWordmark
							className={authLayoutStyles.wordmark}
							data-flx="auth.flow.auth-card-container.aethernet-wordmark"
						/>
					</div>
				)}
				<div
