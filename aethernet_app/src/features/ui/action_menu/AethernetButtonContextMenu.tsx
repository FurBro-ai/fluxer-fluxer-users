...
interface AethernetButtonContextMenuProps {
	onClose: () => void;
}

export const AethernetButtonContextMenu: React.FC<AethernetButtonContextMenuProps> = observer(({onClose}) => {
	...
	return (
		<>
			<MenuGroup data-flx="ui.action-menu.aethernet-button-context-menu.menu-group">
				<MenuItem
					icon={<MarkAsReadIcon data-flx="ui.action-menu.aethernet-button-context-menu.mark-as-read-icon" />}
					onClick={handleMarkAllDmsRead}
					disabled={unreadDmIds.length === 0}
					data-flx="ui.action-menu.aethernet-button-context-menu.menu-item.mark-all-dms-read"
				>
				...
				<MenuItem
					icon={
						inlineDmsCollapsed ? (
							<ViewDetailsIcon data-flx="ui.action-menu.aethernet-button-context-menu.view-details-icon" />
						) : (
							<HideIcon data-flx="ui.action-menu.aethernet-button-context-menu.hide-icon" />
						)
					}
					onClick={handleToggleInlineDms}
					data-flx="ui.action-menu.aethernet-button-context-menu.menu-item.toggle-inline-dms"
				>
				...
				<CheckboxItem
					...
					data-flx="ui.action-menu.aethernet-button-context-menu.checkbox-item"
				>
				...
				<CheckboxItem
					...
					data-flx="ui.action-menu.aethernet-button-context-menu.checkbox-item--2"
				>
					{i18n._(SHOW_INCOMING_FRIEND_REQUEST_COUNT_DESCRIPTOR)}
				</CheckboxItem>
				<MenuItem
					icon={<MarkAsReadIcon data-flx="ui.action-menu.aethernet-button-context-menu.mark-as-read-icon--2" />}
					onClick={handleMarkAllCommunitiesRead}
					disabled={unreadGuildChannelIds.length === 0}
					data-flx="ui.action-menu.aethernet-button-context-menu.menu-item.mark-all-communities-read"
				>
					{i18n._(MARK_ALL_COMMUNITIES_AS_READ_DESCRIPTOR)}
				</MenuItem>
			</MenuGroup>
			<MenuGroup data-flx="ui.action-menu.aethernet-button-context-menu.menu-group--2">
				<BulkGuildSettingsMenuItems
					guilds={guilds}
					onClose={onClose}
					data-flx="ui.action-menu.aethernet-button-context-menu.bulk-guild-settings-menu-items"
				/>
			</MenuGroup>
			<MenuGroup data-flx="ui.action-menu.aethernet-button-context-menu.menu-group--3">
				<BulkDMSettingsMenuItems
					channels={dmChannels}
					onClose={onClose}
					data-flx="ui.action-menu.aethernet-button-context-menu.bulk-dm-settings-menu-items"
				/>
			</MenuGroup>
		</>
	);
