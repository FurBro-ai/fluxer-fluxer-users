...
import AethernetLogoAsset from '@app/media/images/aethernet-logo.svg?react';
...
export const AethernetLogo = observer((props: BrandSvgProps) => {
	...
	if (RuntimeConfig.logoUrl) {
		return (
			<img
				...
				alt={ariaLabel}
				data-flx={getDataFlx(props, 'ui.icons.aethernet-logo.img')}
			/>
		);
	}
	return <AethernetLogoAsset role="img" aria-label={ariaLabel} data-flx="ui.icons.aethernet-logo.img" {...props} />;
});
