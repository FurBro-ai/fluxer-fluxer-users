...
import type {FavoriteGifMediaFormat as FavoriteGifMediaFormatProto} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/pickers_pb';
import {FavoriteGifSettingsSchema} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/pickers_pb';
import {
