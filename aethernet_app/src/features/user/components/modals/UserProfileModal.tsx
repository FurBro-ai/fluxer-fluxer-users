...
import {PublicUserFlags, RelationshipTypes} from '@aethernet/constants/src/UserConstants';
				...
				<>
					...
					<MenuGroup data-flx="user.user-profile-modal.open-more-options-menu.menu-group--3">
						<MenuItem
							...
							onClick={() => {
								handleCopyAethernetTag();
								props.onClose();
							}}
							data-flx="user.user-profile-modal.open-more-options-menu.menu-item.copy-aethernet-tag"
						>
