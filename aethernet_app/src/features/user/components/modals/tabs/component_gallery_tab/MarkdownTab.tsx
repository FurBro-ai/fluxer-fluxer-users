...
import {MessagePreviewContext, MessageStates, MessageTypes} from '@aethernet/constants/src/ChannelConstants';
	...
	const {fakeChannel, createMessage, markdownSections} = useMemo(() => {
		...
		const markdownSections = [
			...
			},
			{
				...
				items: [
					{label: '[text](url)', content: '[Masked Link](https://aethernet.app)'},
					{label: '<url>', content: '<https://aethernet.app>'},
					{label: 'url', content: 'https://aethernet.app'},
					{label: '<email>', content: '<contact@aethernet.app>'},
				],
			},
			{
