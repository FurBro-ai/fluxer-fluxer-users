...
import {ChannelTypes, MessagePreviewContext, MessageTypes} from '@aethernet/constants/src/ChannelConstants';
import type {
	EmbedAuthorResponse,
	EmbedFooterResponse,
	EmbedMediaResponse,
...
} from '@aethernet/schema/src/domains/message/EmbedSchemas';
