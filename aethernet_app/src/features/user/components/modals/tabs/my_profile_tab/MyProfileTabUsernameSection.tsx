...
import {AethernetTagChangeModal} from '@app/features/user/components/modals/AethernetTagChangeModal';
				...
				{!isClaimed ? (
					...
					<Button
						...
						onClick={() =>
							ModalCommands.push(
								modal(() => (
									<AethernetTagChangeModal
										user={user}
										data-flx="user.my-profile-tab.username-section.aethernet-tag-change-modal"
									/>
								)),
							)
						}
