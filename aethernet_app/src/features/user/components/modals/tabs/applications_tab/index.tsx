...
import {AETHERNET_DOCS_DOMAIN, AETHERNET_DOCS_URL} from '@app/features/app/config/I18nDisplayConstants';
				...
				>
					<div className={styles.buttonContainer} data-flx="user.applications-tab.button-container">
						...
						>
							...
							/>
							{i18n._(READ_DOCUMENTATION_DESCRIPTOR, {domain: AETHERNET_DOCS_DOMAIN})}
						</a>
					</div>
					<ApplicationsList
