...
const ABOUT_DESCRIPTOR = msg({
	...
	comment: 'Desktop app menu item. Opens the About panel. {appName} is the desktop app name (typically Aethernet).',
});
...
const WEBSITE_DESCRIPTOR = msg({
	message: 'Website',
	comment: 'Native Help submenu item that opens the Aethernet marketing website.',
});
