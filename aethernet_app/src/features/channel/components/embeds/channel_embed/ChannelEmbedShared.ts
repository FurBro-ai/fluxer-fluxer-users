...
import type {EmbedMedia, MessageEmbed} from '@aethernet/schema/src/domains/message/EmbedSchemas';
import type {MessageAttachment} from '@aethernet/schema/src/domains/message/MessageResponseSchemas';
