...
import {extractTimestampFromSnowflakeAsDate} from '@aethernet/snowflake/src/SnowflakeUtils';
...
export function buildMemberSearchParams({
	...
	if (joinedAethernetFilter.gte != null) {
		searchParams.user_created_at_gte = joinedAethernetFilter.gte;
	}
	if (joinedAethernetFilter.lte != null) {
		searchParams.user_created_at_lte = joinedAethernetFilter.lte;
	}
