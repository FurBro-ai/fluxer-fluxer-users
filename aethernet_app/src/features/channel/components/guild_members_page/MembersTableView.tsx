...
export const MembersTableView: React.FC<{guildId: string}> = observer(({guildId}) => {
	...
	const [joinedAethernetFilter, setJoinedAethernetFilter] = useState<DateRangeFilter>({});
	...
	const filterKey = useMemo(
		() =>
			JSON.stringify({
				...
				roleFilter,
				memberSinceFilter,
				joinedAethernetFilter,
				joinMethodFilter,
			}),
		[searchQuery, sortMode, pageSize, roleFilter, memberSinceFilter, joinedAethernetFilter, joinMethodFilter],
	);
	...
	const performSearch = useCallback(
		...
		[guildId, sortMode, pageSize, roleFilter, memberSinceFilter, joinedAethernetFilter, joinMethodFilter],
	);
	useEffect(() => {
	...
	const handleJoinedAethernetFilterOpen = useCallback(
		(event: React.MouseEvent<HTMLButtonElement>) => {
			openDateRangeFilter(event, joinedAethernetFilter, setJoinedAethernetFilter);
		},
		[openDateRangeFilter, joinedAethernetFilter],
	);
	...
	const joinedAethernetActive = isDateRangeFilterActive(joinedAethernetFilter);
