...
const INSTALLING_UPDATE_DESCRIPTOR = msg({
	...
	comment:
		'Tooltip on the channel header updater icon while a Aethernet Desktop update is being installed. version is the target version. Trailing horizontal ellipsis is intentional.',
});
const INSTALLING_UPDATE_2_DESCRIPTOR = msg({
	message: 'Installing desktop update…',
	comment:
		'Tooltip on the channel header updater icon while a Aethernet Desktop update is being installed when version is not known. Trailing horizontal ellipsis is intentional.',
});
