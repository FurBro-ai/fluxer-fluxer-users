...
const SEND_A_FRIEND_REQUEST_TO_OR_USE_THE_DESCRIPTOR = msg({
	...
	comment:
		'Body of the staff-only add-friend confirmation modal. The staff override is a Aethernet-staff-only feature that bypasses the normal request flow. {userName} is the target user.',
});
