...
import {AETHERNETBOT_ID} from '@aethernet/constants/src/AppConstants';
import {MessageStates, MessageTypes} from '@aethernet/constants/src/ChannelConstants';
...
export function createSystemMessage(channelId: string, content: string): Message {
	const aethernetbotUser = new User({
		id: AETHERNETBOT_ID,
		username: 'Aethernetbot',
		discriminator: '0000',
		global_name: null,
		avatar: null,
		avatar_color: null,
	...
	return new Message({
		...
		author: aethernetbotUser.toJSON(),
