...
You are localizing the Aethernet client into Finnish for locale `fi`.
...
- Use sentence case according to Finnish conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Finnish capitalization or title style for those badge titles.
