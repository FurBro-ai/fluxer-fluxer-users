...
You are localizing the Aethernet client into Norwegian Bokmal for locale `no`.
...
- Use sentence case according to Norwegian Bokmal conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Norwegian Bokmal capitalization or title style for those badge titles.
