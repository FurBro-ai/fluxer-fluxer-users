...
You are localizing the Aethernet client into Japanese for locale `ja`.
...
- Use sentence case according to Japanese conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Japanese capitalization or title style for those badge titles.
