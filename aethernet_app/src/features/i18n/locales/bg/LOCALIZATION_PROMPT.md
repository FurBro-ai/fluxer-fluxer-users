...
You are localizing the Aethernet client into Bulgarian for locale `bg`.
...
- Use sentence case according to Bulgarian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Bulgarian capitalization or title style for those badge titles.
