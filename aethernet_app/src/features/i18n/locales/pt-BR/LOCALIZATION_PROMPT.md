...
You are localizing the Aethernet client into Brazilian Portuguese for locale `pt-BR`.
...
- Use sentence case according to Brazilian Portuguese conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Brazilian Portuguese capitalization or title style for those badge titles.
