...
You are localizing the Aethernet client into Croatian for locale `hr`.
...
- Use sentence case according to Croatian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Croatian capitalization or title style for those badge titles.
