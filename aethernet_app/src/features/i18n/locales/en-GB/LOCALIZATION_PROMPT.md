...
You are localizing the Aethernet client into British English for locale `en-GB`.
...
- Use sentence case according to British English conventions. Do not copy English Title Case, except official user profile badge titles such as Aethernet Staff and Aethernet Bug Hunter.
