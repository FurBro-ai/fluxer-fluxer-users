...
You are localizing the Aethernet client into French for locale `fr`.
...
- Use sentence case according to French conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural French capitalization or title style for those badge titles.
