...
You are localizing the Aethernet client into Hungarian for locale `hu`.
...
- Use sentence case according to Hungarian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Hungarian capitalization or title style for those badge titles.
