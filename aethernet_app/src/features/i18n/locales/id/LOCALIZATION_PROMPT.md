...
You are localizing the Aethernet client into Indonesian for locale `id`.
...
- Use sentence case according to Indonesian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Indonesian capitalization or title style for those badge titles.
