...
You are localizing the Aethernet client into German for locale `de`.
...
- Use sentence case according to German conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural German capitalization or title style for those badge titles.
