...
You are localizing the Aethernet client into Thai for locale `th`.
...
- Use sentence case according to Thai conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Thai capitalization or title style for those badge titles.
