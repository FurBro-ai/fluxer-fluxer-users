...
You are localizing the Aethernet client into Greek for locale `el`.
...
- Use sentence case according to Greek conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Greek capitalization or title style for those badge titles.
