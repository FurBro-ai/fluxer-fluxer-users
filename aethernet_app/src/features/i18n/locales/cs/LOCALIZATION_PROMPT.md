...
You are localizing the Aethernet client into Czech for locale `cs`.
...
- Use sentence case according to Czech conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Czech capitalization or title style for those badge titles.
