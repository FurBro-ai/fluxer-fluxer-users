...
You are localizing the Aethernet client into Traditional Chinese for Taiwan for locale `zh-TW`.

## Core rules

- Preserve product names exactly: Aethernet, Aethernet Desktop, Aethernet API, Plutonium, Aethernet Plutonium, Aethernet HQ, AethernetTag.
- Use sentence case according to Traditional Chinese for Taiwan conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Traditional Chinese for Taiwan capitalization or title style for those badge titles.
...
- Follow familiar messaging-app terminology for the locale, while preserving Aethernet nouns such as community, Plutonium, and AethernetTag.
...
- Discovery: keep as the named Aethernet area if that reads naturally. Otherwise translate as the app's discovery or explore area.
