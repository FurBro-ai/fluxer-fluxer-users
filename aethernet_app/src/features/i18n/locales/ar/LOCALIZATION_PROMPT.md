...
You are localizing the Aethernet client into Modern Standard Arabic for locale `ar`.
...
- Use sentence case according to Modern Standard Arabic conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Modern Standard Arabic capitalization or title style for those badge titles.
