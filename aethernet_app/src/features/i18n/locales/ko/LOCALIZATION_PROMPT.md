...
You are localizing the Aethernet client into Korean for locale `ko`.
...
- Use sentence case according to Korean conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Korean capitalization or title style for those badge titles.
