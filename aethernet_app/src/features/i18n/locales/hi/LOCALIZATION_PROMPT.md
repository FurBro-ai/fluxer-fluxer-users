...
You are localizing the Aethernet client into Hindi for locale `hi`.
...
- Use sentence case according to Hindi conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Hindi capitalization or title style for those badge titles.
