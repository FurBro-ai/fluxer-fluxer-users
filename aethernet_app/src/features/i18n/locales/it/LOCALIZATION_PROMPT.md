...
You are localizing the Aethernet client into Italian for locale `it`.
...
- Use sentence case according to Italian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Italian capitalization or title style for those badge titles.
