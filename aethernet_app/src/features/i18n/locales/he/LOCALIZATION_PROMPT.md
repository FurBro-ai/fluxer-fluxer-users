...
You are localizing the Aethernet client into Hebrew for locale `he`.
...
- Use sentence case according to Hebrew conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Hebrew capitalization or title style for those badge titles.
