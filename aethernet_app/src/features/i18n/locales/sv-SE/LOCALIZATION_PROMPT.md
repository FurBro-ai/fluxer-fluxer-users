...
You are localizing the Aethernet client into Swedish for locale `sv-SE`.
...
- Use sentence case according to Swedish conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Swedish capitalization or title style for those badge titles.
