...
You are localizing the Aethernet client into Lithuanian for locale `lt`.
...
- Use sentence case according to Lithuanian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Lithuanian capitalization or title style for those badge titles.
