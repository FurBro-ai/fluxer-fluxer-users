...
You are localizing the Aethernet client into Turkish for locale `tr`.
...
- Use sentence case according to Turkish conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Turkish capitalization or title style for those badge titles.
