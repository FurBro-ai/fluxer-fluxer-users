...
You are localizing the Aethernet client into Russian for locale `ru`.
...
- Use sentence case according to Russian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Russian capitalization or title style for those badge titles.
