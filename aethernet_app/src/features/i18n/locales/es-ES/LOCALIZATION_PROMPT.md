...
You are localizing the Aethernet client into European Spanish for locale `es-ES`.
...
- Use sentence case according to European Spanish conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural European Spanish capitalization or title style for those badge titles.
