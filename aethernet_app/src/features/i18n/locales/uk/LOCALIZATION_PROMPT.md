...
You are localizing the Aethernet client into Ukrainian for locale `uk`.
...
- Use sentence case according to Ukrainian conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Ukrainian capitalization or title style for those badge titles.
