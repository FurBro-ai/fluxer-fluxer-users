...
You are localizing the Aethernet client into Dutch for locale `nl`.
...
- Use sentence case according to Dutch conventions. Do not copy English Title Case, including for English source badge titles such as Aethernet Staff or Aethernet Bug Hunter; use natural Dutch capitalization or title style for those badge titles.
