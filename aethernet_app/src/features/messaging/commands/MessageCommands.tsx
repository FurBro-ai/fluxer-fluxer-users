...
import {MessageFlags, Permissions} from '@aethernet/constants/src/ChannelConstants';
import type {JumpType} from '@aethernet/constants/src/JumpConstants';
import {MAX_MESSAGES_PER_CHANNEL} from '@aethernet/constants/src/LimitConstants';
import type {MessageId} from '@aethernet/schema/src/branded/WireIds';
import type {
	AllowedMentions,
	MessageReference,
	MessageStickerItem,
	Message as WireMessage,
} from '@aethernet/schema/src/domains/message/MessageResponseSchemas';
...
const ALSO_REPORT_TO_SAFETY_TEAM_DESCRIPTOR = msg({
	...
	comment:
		'Toggle-switch label in the moderator delete-message confirmation dialog. When enabled, the message is reported (category: other) before being deleted. {productName} is the product name (e.g., Aethernet).',
});
