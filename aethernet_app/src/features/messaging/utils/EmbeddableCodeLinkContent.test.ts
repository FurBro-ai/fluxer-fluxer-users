...
const TEST_LINK_CONFIG: CodeLinkUtils.CodeLinkConfig = {
	path: 'invite',
	urlBases: ['https://aethernet.app/invite'],
};
...
describe('extractEmbeddableCodeLinkContent', () => {
	it('excludes inline and block code links from code-link detection', () => {
		const content = [
			...
			'`https://aethernet.app/invite/inline-code`',
			'```',
			'https://aethernet.app/invite/block-code',
			'```',
		].join('\n');
	...
	it('keeps masked link URLs and preserves suppressed angle-link behavior', () => {
		const content = [
			'[Join](https://aethernet.app/invite/masked-link)',
			'<https://aethernet.app/invite/suppressed-link>',
		].join('\n');
	...
	it('preserves suppressed angle-link behavior after parsing markdown code', () => {
		const content = ['<https://aethernet.app/invite/suppressed-link>', '`not a link`'].join('\n');
	...
	it('excludes code links from spoilered code-link detection', () => {
		const content = [
			'||https://aethernet.app/invite/visible-spoiler||',
			'||`https://aethernet.app/invite/inline-spoiler`||',
			'```',
			'||https://aethernet.app/invite/block-spoiler||',
			'```',
		].join('\n');
