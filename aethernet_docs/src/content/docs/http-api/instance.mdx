...
The approximate location Aethernet resolved for the request, together with the regions where mature content is gated behind an age check or is unavailable.
...
<RouteHeader method="GET" path="/.well-known/aethernet" unauthenticated />
