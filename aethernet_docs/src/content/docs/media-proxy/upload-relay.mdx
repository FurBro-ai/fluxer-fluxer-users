...
Relay CORS means `Access-Control-Allow-Origin: *`, `Access-Control-Allow-Headers: Content-Type, Content-Length, Authorization, X-Aethernet-Features, X-Client-Context`, and `Access-Control-Expose-Headers: ETag, X-Aethernet-Version`.
