...
if (process.env.AETHERNET_DOCS_SCHEMA_JSON != null) {
	...
	await writeFile(process.env.AETHERNET_DOCS_SCHEMA_JSON, JSON.stringify(payload, null, 1));
	console.log(`wrote ${process.env.AETHERNET_DOCS_SCHEMA_JSON}`);
}
