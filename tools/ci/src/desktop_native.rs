...
const LINUX_AUDIO_CAPTURE_PKG_CONFIG: &[PkgConfigRequirement] = &[PkgConfigRequirement {
    ...
    message: "@aethernet/linux-audio-capture requires libpipewire-0.3-dev (or your distro's equivalent: `apt install libpipewire-0.3-dev`, `dnf install pipewire-devel`, `apk add pipewire-dev`) to build. Install it on the build host, then re-run `pnpm build`.",
}];

const DESKTOP_NATIVE_ADDONS: &[DesktopNativeAddon] = &[
    DesktopNativeAddon {
        package_dir: "hardware-encoder",
        package_name: "@aethernet/hardware-encoder",
        crate_name: "aethernet_hardware_encoder",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/linux-audio-capture",
        crate_name: "aethernet_linux_audio_capture",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/linux-evdev",
        crate_name: "aethernet_linux_evdev",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/linux-input-hook",
        crate_name: "aethernet_linux_input_hook",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/linux-notifications",
        crate_name: "aethernet_linux_notifications",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/linux-portals",
        crate_name: "aethernet_linux_portals",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/linux-screen-capture",
        crate_name: "aethernet_linux_screen_capture",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/mac-app-audio",
        crate_name: "aethernet_mac_app_audio",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/mac-clipboard",
        crate_name: "aethernet_mac_clipboard",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/mac-screen-capture",
        crate_name: "aethernet_mac_screen_capture",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/mac-sysctl",
        crate_name: "aethernet_mac_sysctl",
    ...
    DesktopNativeAddon {
        package_dir: "mac-tcc",
        package_name: "@aethernet/mac-tcc",
        crate_name: "aethernet_mac_tcc",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/macos-input-hook",
        crate_name: "aethernet_macos_input_hook",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/platform-info",
        crate_name: "aethernet_platform_info",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/system-hunspell",
        crate_name: "aethernet_system_hunspell",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/webauthn",
        crate_name: "aethernet_webauthn",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/win-clipboard",
        crate_name: "aethernet_win_clipboard",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/win-game-capture",
        crate_name: "aethernet_win_game_capture",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/win-process-loopback",
        crate_name: "aethernet_win_process_loopback",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/win-shell",
        crate_name: "aethernet_win_shell",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/win-toast",
        crate_name: "aethernet_win_toast",
    ...
    DesktopNativeAddon {
        ...
        package_name: "@aethernet/windows-input-hook",
        crate_name: "aethernet_windows_input_hook",
...
fn default_windows_cargo_target_root(addon_root: &Path) -> Result<PathBuf> {
    let base = env::var_os("AETHERNET_CARGO_TARGET_BASE")
        .filter(|value| !value.is_empty())
        .map(PathBuf::from)
        .unwrap_or_else(|| {
...
fn remove_stale_win_game_capture_outputs(root: &Path, primary_node: &Path) -> Result<()> {
    ...
    stale.retain(|path| {
        ...
        file_name.starts_with("aethernet-game-hook.")
            || file_name.starts_with("aethernet-inject-helper.")
            || file_name.starts_with("aethernet-vulkan-layer.")
...
mod tests {
    ...
    fn dynamic_library_names_match_legacy_node_helper() {
        assert_eq!(
            cargo_dynamic_library_file_name("aethernet_webauthn", "linux").unwrap(),
            "libaethernet_webauthn.so"
        );
        assert_eq!(
            cargo_dynamic_library_file_name("aethernet-webauthn", "darwin").unwrap(),
            "libaethernet_webauthn.dylib"
        );
        assert_eq!(
            cargo_dynamic_library_file_name("aethernet_webauthn", "win32").unwrap(),
            "aethernet_webauthn.dll"
        );
    }
