...
pub(crate) const RELEASE_REPOSITORY: &str = "aethernetapp/aethernet";
const RELEASE_COMPARE_URL: &str = "https://github.com/aethernetapp/aethernet/compare";
...
pub(crate) fn validate_desktop_release_descriptor(
    ...
    source_sha: &str,
        ...
        descriptor.release_tag == format!("aethernet-desktop-{channel}@{version}"),
...
fn desktop_channel(component: &str) -> Option<&str> {
    component.strip_prefix("aethernet-desktop-")
}
