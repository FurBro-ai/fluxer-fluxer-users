...
pub static DEV_STATE_DIR: LazyLock<PathBuf> = LazyLock::new(|| ROOT.join(".aethernet/dev"));
...
pub static DESKTOP_DIR: LazyLock<PathBuf> = LazyLock::new(|| ROOT.join("aethernet_desktop"));
pub static GATEWAY_CONFIG_DIR: LazyLock<PathBuf> =
    LazyLock::new(|| ROOT.join("aethernet_gateway/config"));
