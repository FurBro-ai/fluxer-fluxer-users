...
pub const DEV_PROXY_GATEWAY_PORTS_ENV: &str = "AETHERNET_DEV_PROXY_GATEWAY_PORTS";
pub const APP_PORT: u16 = 3001;
...
pub fn rust_services() -> Vec<RustServiceSpec> {
    vec![
        RustServiceSpec {
            name: "gifs",
            package: "aethernet-gifs",
            path: ROOT.join("aethernet_gifs"),
            port_base: 8110,
        },
        RustServiceSpec {
            name: "messages",
            package: "aethernet-messages",
            path: ROOT.join("aethernet_messages"),
            port_base: 8112,
        },
        RustServiceSpec {
            name: "snowflakes",
            package: "aethernet-snowflakes",
            path: ROOT.join("aethernet_snowflakes"),
            port_base: 8120,
        },
        RustServiceSpec {
            name: "unfurl",
            package: "aethernet-unfurl",
            path: ROOT.join("aethernet_unfurl"),
            port_base: 8122,
        },
        RustServiceSpec {
            name: "users",
            package: "aethernet-users",
            path: ROOT.join("aethernet_users"),
            port_base: 8124,
        },
    ]
}
