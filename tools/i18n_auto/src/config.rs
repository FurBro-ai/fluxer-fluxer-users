...
pub const DEFAULT_OPENROUTER_HTTP_REFERER: &str = "https://aethernet.chat";
pub const DEFAULT_OPENROUTER_APP_TITLE: &str = "Aethernet i18n auto";
...
pub fn default_app_dir() -> PathBuf {
    ...
    manifest_dir
        ...
        .map(|repo_root| repo_root.join("aethernet_app"))
        .unwrap_or_else(|| PathBuf::from("aethernet_app"))
}
