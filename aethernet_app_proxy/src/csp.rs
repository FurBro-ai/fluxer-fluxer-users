...
const CONNECT_SOURCES: &[&str] = &[
    ...
    "https://*.aethernet.media",
    "wss://*.aethernet.media",
    "https://aethernet-uploads.ewr1.vultrobjects.com",
    "https://hcaptcha.com",
    "https://*.hcaptcha.com",
    "https://challenges.cloudflare.com",
    "https://aethernetstatus.com",
    "https://aethernet.media",
];

const WORKER_SOURCES: &[&str] = &["https://*.aethernet.app", "blob:"];

const MANIFEST_SOURCES: &[&str] = &["https://*.aethernet.app"];
...
mod tests {
    ...
    fn build_csp_includes_s3_public_and_virtual_hosted_upload_origins() {
        ...
        let runtime_sources = RuntimeCspSources {
            ...
            s3_uploads_endpoint: Some(endpoint("http://aethernet-uploads.localhost:3900/")),
            ..Default::default()
        };
        ...
        assert!(csp.contains("http://aethernet-uploads.localhost:3900"));
        assert!(!csp.contains("http://localhost:3900/ "));
    }
