...
const CANARY_USER_AGENT_PRODUCT: &str = "AethernetCanary/";
...
mod tests {
    ...
    fn canary_user_agent_at_min_version_is_exempt() {
        ...
        headers.insert(
            header::USER_AGENT,
            HeaderValue::from_static("AethernetCanary/2026.614.0"),
        );
    ...
    fn canary_user_agent_newer_than_min_version_is_exempt() {
        ...
        headers.insert(
            header::USER_AGENT,
            HeaderValue::from_static("Mozilla/5.0 AethernetCanary/2026.614.83512 Electron/99.0"),
        );
    ...
    fn canary_user_agent_before_min_version_stays_frozen() {
        ...
        headers.insert(
            header::USER_AGENT,
            HeaderValue::from_static("AethernetCanary/2026.613.235959"),
        );
    ...
    fn malformed_canary_user_agent_stays_frozen() {
        ...
        headers.insert(
            header::USER_AGENT,
            HeaderValue::from_static("AethernetCanary/2026.614.not-a-calver"),
        );
    ...
    fn stable_user_agent_stays_frozen() {
        ...
        headers.insert(
            header::USER_AGENT,
            HeaderValue::from_static("AethernetStable/2026.614.83512"),
        );
