...
variable "AETHERNET_APP_PROXY_TIME_FREEZE_ENABLED" { default = "true" }
...
target "app-proxy" {
	dockerfile = "aethernet_app_proxy/Dockerfile"
	context    = "."
	...
	args = {
		...
		AETHERNET_APP_PROXY_TIME_FREEZE_ENABLED = AETHERNET_APP_PROXY_TIME_FREEZE_ENABLED
