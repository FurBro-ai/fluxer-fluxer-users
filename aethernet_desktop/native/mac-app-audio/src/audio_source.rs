...
pub struct Source {
    pub delegate: Retained<AethernetSCKAudioSource>,
    pub state: Machine,
    pub target_sample_rate: f64,
    pub target_channels: u32,
...
define_class!(
    ...
    #[name = "AethernetSCKAudioSource"]
    #[ivars = DelegateIvars]
    pub struct AethernetSCKAudioSource;

    unsafe impl NSObjectProtocol for AethernetSCKAudioSource {}

    unsafe impl SCStreamDelegate for AethernetSCKAudioSource {
    ...
    unsafe impl SCStreamOutput for AethernetSCKAudioSource {
...
impl Source {
    pub fn create(opts: SourceOptions) -> Result<Box<Source>, SourceCreateError> {
        ...
        let delegate = AethernetSCKAudioSource::new();
        ...
        let queue =
            dispatch2::DispatchQueue::new("app.aethernet.mac-app-audio.sck", Some(&queue_attr));
