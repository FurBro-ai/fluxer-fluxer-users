...
const NATIVE_LOAD_ERROR_MARKER = Symbol.for('aethernet.nativeLoadError');
const MAX_TEXT_LENGTH = 6000;
const MAX_DIRECTORY_ENTRIES = 80;
const PREFLIGHT_CHILD_ENV = 'AETHERNET_NATIVE_MODULE_PREFLIGHT_CHILD';
const PROBE_TIMEOUT_ENV = 'AETHERNET_NATIVE_PROBE_TIMEOUT_MS';
const DEFAULT_PROBE_TIMEOUT_MS = 30000;
const PROBE_REACHED_REQUIRE_MARKER = '__aethernet_native_probe_reached_require__';
...
function selectedEnvironmentNames(skipNativeProbeEnv) {
	const names = [
		...
		'AETHERNET_NATIVE_MODULE_PREFLIGHT_CHILD',
		'LD_LIBRARY_PATH',
		'DYLD_LIBRARY_PATH',
		'DISPLAY',
		'WAYLAND_DISPLAY',
