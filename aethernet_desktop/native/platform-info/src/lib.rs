...
fn base_device(
    ...
    PlatformGpuDeviceInfo {
        ...
        vendor_id,
        device_id,
        vendor_name: aethernet_desktop_native::platform_info::probe_helpers::vendor_name(vendor_id)
            .map(str::to_owned),
        device_string: None,
        driver_vendor: None,
        driver_version: None,
...
#[cfg(target_os = "macos")]
mod platform {
    use aethernet_desktop_native::platform_info::probe_helpers::{
...
mod platform {
    ...
    use aethernet_desktop_native::platform_info::probe_helpers::vendor_name;
