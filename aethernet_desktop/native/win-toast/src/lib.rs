...
mod tests {
    ...
    fn valid_raw_options() -> RawToastNotifyOptions {
        RawToastNotifyOptions {
            aumid: Some("com.aethernet.Desktop".to_string()),
            tag: None,
            group: None,
    ...
    fn toast_xml_escapes_values_and_preserves_shape() {
        let spec = ToastSpec {
            aumid: "com.aethernet.Desktop".to_string(),
            ...
            actions: vec![ToastActionSpec {
                ...
                args: "aethernet://open?x=1&y=2".to_string(),
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "<text placement=\"attribution\">via Aethernet</text>",
                "</binding></visual>",
                "<actions>",
                "<input id=\"reply\" type=\"selection\" placeHolderContent=\"Say &quot;hi&quot;\" title=\"Pick\">",
                "<selection id=\"yes\" content=\"Yes &amp; go\"/>",
                "</input>",
                "<action content=\"Open &lt;now&gt;\" arguments=\"aethernet://open?x=1&amp;y=2\" activationType=\"foreground\" imageUri=\"file:///icon.png\" hint-inputId=\"reply\"/>",
                "</actions>",
    ...
    fn non_windows_worker_preserves_stub_error_contract() {
        ...
        let err = platform::history_op("com.aethernet.Desktop", &HistoryOp::Clear)
