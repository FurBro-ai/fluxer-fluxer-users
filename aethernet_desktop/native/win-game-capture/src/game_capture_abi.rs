...
pub const ENV_DISABLE_HOOK: &str = "AETHERNET_GAME_CAPTURE_DISABLE_HOOK";
pub const ENV_DISABLE_D3D12: &str = "AETHERNET_GAME_CAPTURE_DISABLE_D3D12";
pub const ENV_DISABLE_VULKAN: &str = "DISABLE_AETHERNET_VULKAN_CAPTURE";
pub const ENV_FORCE_CPU: &str = "AETHERNET_GAME_CAPTURE_FORCE_CPU";
pub const ENV_FORCE_SHARED_TEXTURE: &str = "AETHERNET_GAME_CAPTURE_FORCE_SHARED_TEXTURE";
pub const ENV_ENABLE_OPENGL_SHARED_TEXTURE: &str =
    "AETHERNET_GAME_CAPTURE_ENABLE_OPENGL_SHARED_TEXTURE";
pub const ENV_DISABLE_OPENGL_SHARED_TEXTURE: &str =
    "AETHERNET_GAME_CAPTURE_DISABLE_OPENGL_SHARED_TEXTURE";
pub const ENV_VERBOSE: &str = "AETHERNET_GAME_CAPTURE_VERBOSE";
pub const ENV_INJECT_METHOD: &str = "AETHERNET_GAME_CAPTURE_INJECT_METHOD";
...
pub const GAME_CAPTURE_INFO_PREFIX: &str = "AethernetGameCapture_Info_";
pub const GAME_CAPTURE_FRAME_PREFIX: &str = "AethernetGameCapture_Frame_";
pub const GAME_CAPTURE_READY_PREFIX: &str = "AethernetGameCapture_Ready_";
pub const GAME_CAPTURE_STOP_PREFIX: &str = "AethernetGameCapture_Stop_";
pub const GAME_CAPTURE_KEEPALIVE_PREFIX: &str = "AethernetGameCapture_KeepAlive_";
pub const GAME_CAPTURE_MUTEX_PREFIX: &str = "AethernetGameCapture_FrameMutex_";
