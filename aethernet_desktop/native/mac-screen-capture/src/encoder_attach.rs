...
#[cfg(target_os = "macos")]
use aethernet_encoder_ring::FillReservation;

#[cfg(target_os = "macos")]
use aethernet_encoder_ring::VtPixelTransfer;
...
mod tests {
    ...
    fn external_surface_submit_take_round_trip() {
        use core::ptr::NonNull;
        use aethernet_encoder_ring::metal_iosurface_macos::OwnedIoSurface;
