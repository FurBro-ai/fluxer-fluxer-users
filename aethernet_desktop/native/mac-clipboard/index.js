...
const MODULE_NAME = '@aethernet/mac-clipboard';
const SKIP_NATIVE_PROBE_ENV = 'AETHERNET_MAC_CLIPBOARD_SKIP_NATIVE_PROBE';
...
function nativeFileName() {
	if (process.platform !== 'darwin') {
		throw new Error(`@aethernet/mac-clipboard is only supported on macOS, got ${process.platform}`);
	}
	switch (process.arch) {
		case 'x64':
