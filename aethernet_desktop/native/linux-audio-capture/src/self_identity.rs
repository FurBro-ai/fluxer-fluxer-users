...
const PRODUCT_DISPLAY_NAMES: &[&str] = &["Aethernet", "Aethernet Canary"];
const PRODUCT_DISPLAY_PREFIXES: &[&str] = &[
    "Aethernet ", "aethernet ", "Aethernet-", "aethernet-", "Aethernet_", "aethernet_", "Aethernet.", "aethernet.",
];
...
mod tests {
    ...
    fn strip_exe_suffix_handles_known_extensions() {
        assert_eq!(Some("aethernet"), strip_exe_suffix("aethernet.AppImage"));
        assert_eq!(Some("aethernet"), strip_exe_suffix("aethernet.bin"));
        assert_eq!(None, strip_exe_suffix("aethernet"));
        assert_eq!(Some("aethernet"), strip_exe_suffix("aethernet.APPIMAGE"));
    }
