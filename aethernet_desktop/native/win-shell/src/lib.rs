...
mod tests {
    ...
    fn valid_raw_options() -> CreateShortcutOptions {
        CreateShortcutOptions {
            lnk_path: Some("C:\\Users\\Example\\Desktop\\Aethernet.lnk".to_string()),
            target: Some("C:\\Program Files\\Aethernet\\Aethernet.exe".to_string()),
            args: None,
    ...
    fn valid_run_value_options() -> SetRunValueOptions {
        SetRunValueOptions {
            name: Some("velopack.aethernet_desktop_canary".to_string()),
            command: Some(
                "\"C:\\Users\\Example\\AppData\\Local\\Aethernet\\Aethernet.exe\" --autostart"
                    .to_string(),
            ),
        }
    }
    ...
    fn validation_preserves_optional_fields() {
        ...
        raw.icon_path = Some("C:\\Program Files\\Aethernet\\Aethernet.exe".to_string());
        raw.icon_index = Some(2);
        raw.working_dir = Some("C:\\Program Files\\Aethernet".to_string());
        raw.description = Some("Aethernet desktop client".to_string());
        raw.app_user_model_id = Some("velopack.aethernet_desktop".to_string());
        ...
        assert_eq!(
            ...
            Some("velopack.aethernet_desktop")
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            Some("C:\\Program Files\\Aethernet\\Aethernet.exe")
        );
        assert_eq!(opts.icon_index, 2);
        assert_eq!(
            opts.working_dir.as_deref(),
            Some("C:\\Program Files\\Aethernet")
        );
        assert_eq!(opts.description.as_deref(), Some("Aethernet desktop client"));
    }
    ...
    fn run_value_validation_preserves_fields() {
        ...
        assert_eq!(opts.name, "velopack.aethernet_desktop_canary");
        assert_eq!(
            opts.command,
            "\"C:\\Users\\Example\\AppData\\Local\\Aethernet\\Aethernet.exe\" --autostart"
        );
