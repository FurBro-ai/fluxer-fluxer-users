...
const productName = isCanary ? 'AETHERNET Canary' : 'AETHERNET';
const artifactProductName = isCanary ? 'AETHERNET-Canary' : 'AETHERNET';
const appId = isCanary ? 'app.aethernet.canary' : 'app.aethernet';
const iconDir = isCanary ? 'icons-canary' : 'icons-stable';
const packageName = isCanary ? 'aethernet_desktop_canary' : 'aethernet_desktop';
const linuxPackageName = isCanary ? 'aethernet-canary' : 'aethernet';
...
const provisioningProfile = isCanary
	? 'build_resources/profiles/Aethernet_Canary.provisionprofile'
	: 'build_resources/profiles/Aethernet.provisionprofile';
...
const aethernetNativePackages = [
	'@aethernet/mac-app-audio',
	'@aethernet/mac-clipboard',
	'@aethernet/mac-screen-capture',
	'@aethernet/mac-sysctl',
	'@aethernet/mac-tcc',
	'@aethernet/macos-input-hook',
	'@aethernet/win-process-loopback',
	'@aethernet/win-game-capture',
	'@aethernet/win-clipboard',
	'@aethernet/win-shell',
	'@aethernet/win-toast',
	'@aethernet/windows-input-hook',
	'@aethernet/linux-audio-capture',
	'@aethernet/linux-portals',
	'@aethernet/linux-screen-capture',
	'@aethernet/linux-notifications',
	'@aethernet/linux-evdev',
	'@aethernet/linux-input-hook',
	'@aethernet/system-hunspell',
	'@aethernet/hardware-encoder',
	'@aethernet/platform-info',
	'@aethernet/webauthn',
];
const aethernetNativePackagesByPlatform = {
	darwin: [
		'@aethernet/mac-app-audio',
		'@aethernet/mac-clipboard',
		'@aethernet/mac-screen-capture',
...
const nativeRuntimeFilePatterns = [
	'node_modules/@aethernet/mac-app-audio/package.json',
	'node_modules/@aethernet/mac-app-audio/index.js',
	'node_modules/@aethernet/mac-app-audio/loader-diagnostics.cjs',
	'node_modules/@aethernet/mac-app-audio/*.node',
	'node_modules/@aethernet/mac-screen-capture/package.json',
	'node_modules/@aethernet/mac-screen-capture/index.js',
	'node_modules/@aethernet/mac-screen-capture/loader-diagnostics.cjs',
	'node_modules/@aethernet/mac-screen-capture/*.node',
	'node_modules/@aethernet/mac-clipboard/package.json',
	'node_modules/@aethernet/mac-clipboard/index.js',
	'node_modules/@aethernet/mac-clipboard/loader-diagnostics.cjs',
	'node_modules/@aethernet/mac-clipboard/*.node',
	'node_modules/@aethernet/mac-sysctl/package.json',
	'node_modules/@aethernet/mac-sysctl/index.js',
	'node_modules/@aethernet/mac-sysctl/loader-diagnostics.cjs',
	'node_modules/@aethernet/mac-sysctl/*.node',
	'node_modules/@aethernet/mac-tcc/package.json',
	'node_modules/@aethernet/mac-tcc/index.js',
	'node_modules/@aethernet/mac-tcc/loader-diagnostics.cjs',
	'node_modules/@aethernet/mac-tcc/*.node',
	'node_modules/@aethernet/win-process-loopback/package.json',
	'node_modules/@aethernet/win-process-loopback/index.js',
	'node_modules/@aethernet/win-process-loopback/binding.js',
	'node_modules/@aethernet/win-process-loopback/loader-diagnostics.cjs',
	'node_modules/@aethernet/win-process-loopback/*.node',
	'node_modules/@aethernet/win-game-capture/package.json',
	'node_modules/@aethernet/win-game-capture/index.js',
	'node_modules/@aethernet/win-game-capture/loader-diagnostics.cjs',
	...winGameCaptureTargetArchs.map(
		(arch) => `node_modules/@aethernet/win-game-capture/win-game-capture.win32-${arch}-msvc.node`,
	),
	'node_modules/@aethernet/win-clipboard/package.json',
	'node_modules/@aethernet/win-clipboard/index.js',
	'node_modules/@aethernet/win-clipboard/loader-diagnostics.cjs',
	'node_modules/@aethernet/win-clipboard/*.node',
	'node_modules/@aethernet/win-shell/package.json',
	'node_modules/@aethernet/win-shell/index.js',
	'node_modules/@aethernet/win-shell/loader-diagnostics.cjs',
	'node_modules/@aethernet/win-shell/*.node',
	'node_modules/@aethernet/win-toast/package.json',
	'node_modules/@aethernet/win-toast/index.js',
	'node_modules/@aethernet/win-toast/loader-diagnostics.cjs',
	'node_modules/@aethernet/win-toast/*.node',
	'node_modules/@aethernet/linux-audio-capture/package.json',
	'node_modules/@aethernet/linux-audio-capture/index.js',
	'node_modules/@aethernet/linux-audio-capture/loader-diagnostics.cjs',
	'node_modules/@aethernet/linux-audio-capture/*.node',
	'node_modules/@aethernet/linux-portals/package.json',
	'node_modules/@aethernet/linux-portals/index.js',
	'node_modules/@aethernet/linux-portals/loader-diagnostics.cjs',
	'node_modules/@aethernet/linux-portals/*.node',
	'node_modules/@aethernet/linux-screen-capture/package.json',
	'node_modules/@aethernet/linux-screen-capture/index.js',
	'node_modules/@aethernet/linux-screen-capture/loader-diagnostics.cjs',
	'node_modules/@aethernet/linux-screen-capture/*.node',
	'node_modules/@aethernet/linux-screen-capture/THIRD_PARTY_OBS_VKCAPTURE.md',
	'node_modules/@aethernet/linux-screen-capture/obs-vkcapture/**/*',
	'node_modules/@aethernet/linux-notifications/package.json',
	'node_modules/@aethernet/linux-notifications/index.js',
	'node_modules/@aethernet/linux-notifications/loader-diagnostics.cjs',
	'node_modules/@aethernet/linux-notifications/*.node',
	'node_modules/@aethernet/linux-evdev/package.json',
	'node_modules/@aethernet/linux-evdev/index.js',
	'node_modules/@aethernet/linux-evdev/loader-diagnostics.cjs',
	'node_modules/@aethernet/linux-evdev/*.node',
	'node_modules/@aethernet/system-hunspell/package.json',
	'node_modules/@aethernet/system-hunspell/index.js',
	'node_modules/@aethernet/system-hunspell/loader-diagnostics.cjs',
	'node_modules/@aethernet/system-hunspell/*.node',
	'node_modules/@aethernet/macos-input-hook/package.json',
	'node_modules/@aethernet/macos-input-hook/index.js',
	'node_modules/@aethernet/macos-input-hook/loader-diagnostics.cjs',
	'node_modules/@aethernet/macos-input-hook/*.node',
	'node_modules/@aethernet/windows-input-hook/package.json',
	'node_modules/@aethernet/windows-input-hook/index.js',
	'node_modules/@aethernet/windows-input-hook/loader-diagnostics.cjs',
	'node_modules/@aethernet/windows-input-hook/*.node',
	'node_modules/@aethernet/linux-input-hook/package.json',
	'node_modules/@aethernet/linux-input-hook/index.js',
	'node_modules/@aethernet/linux-input-hook/loader-diagnostics.cjs',
	'node_modules/@aethernet/linux-input-hook/*.node',
	'node_modules/@aethernet/platform-info/package.json',
	'node_modules/@aethernet/platform-info/index.js',
	'node_modules/@aethernet/platform-info/pure.cjs',
	'node_modules/@aethernet/platform-info/loader-diagnostics.cjs',
	'node_modules/@aethernet/platform-info/*.node',
	'node_modules/@aethernet/webauthn/package.json',
	'node_modules/@aethernet/webauthn/index.js',
	'node_modules/@aethernet/webauthn/index.d.ts',
	'node_modules/@aethernet/webauthn/pure.cjs',
	'node_modules/@aethernet/webauthn/loader-diagnostics.cjs',
	'node_modules/@aethernet/webauthn/*.node',
	'node_modules/@aethernet/webauthn/*.so*',
	'node_modules/@aethernet/hardware-encoder/package.json',
	'node_modules/@aethernet/hardware-encoder/index.js',
	'node_modules/@aethernet/hardware-encoder/index.d.ts',
	'node_modules/@aethernet/hardware-encoder/*.node',
	'node_modules/.pnpm/@aethernet+*/node_modules/@aethernet/*/loader-diagnostics.cjs',
	'node_modules/.pnpm/@aethernet+*/node_modules/@aethernet/*/pure.cjs',
	'node_modules/.pnpm/@aethernet+win-process-loopback@*/node_modules/@aethernet/win-process-loopback/*.node',
	...winGameCaptureTargetArchs.map(
		(arch) =>
			`node_modules/.pnpm/@aethernet+win-game-capture@*/node_modules/@aethernet/win-game-capture/win-game-capture.win32-${arch}-msvc.node`,
	),
	'node_modules/.pnpm/@aethernet+win-clipboard@*/node_modules/@aethernet/win-clipboard/*.node',
	'node_modules/.pnpm/@aethernet+win-shell@*/node_modules/@aethernet/win-shell/*.node',
	'node_modules/.pnpm/@aethernet+win-toast@*/node_modules/@aethernet/win-toast/*.node',
	'node_modules/.pnpm/@aethernet+windows-input-hook@*/node_modules/@aethernet/windows-input-hook/*.node',
	'node_modules/.pnpm/@aethernet+linux-audio-capture@*/node_modules/@aethernet/linux-audio-capture/*.node',
	'node_modules/.pnpm/@aethernet+linux-portals@*/node_modules/@aethernet/linux-portals/*.node',
	'node_modules/.pnpm/@aethernet+linux-screen-capture@*/node_modules/@aethernet/linux-screen-capture/*.node',
	'node_modules/.pnpm/@aethernet+linux-screen-capture@*/node_modules/@aethernet/linux-screen-capture/THIRD_PARTY_OBS_VKCAPTURE.md',
	'node_modules/.pnpm/@aethernet+linux-screen-capture@*/node_modules/@aethernet/linux-screen-capture/obs-vkcapture/**/*',
	'node_modules/.pnpm/@aethernet+linux-notifications@*/node_modules/@aethernet/linux-notifications/*.node',
	'node_modules/.pnpm/@aethernet+linux-evdev@*/node_modules/@aethernet/linux-evdev/*.node',
	'node_modules/.pnpm/@aethernet+linux-input-hook@*/node_modules/@aethernet/linux-input-hook/*.node',
	'node_modules/.pnpm/@aethernet+mac-app-audio@*/node_modules/@aethernet/mac-app-audio/*.node',
	'node_modules/.pnpm/@aethernet+mac-screen-capture@*/node_modules/@aethernet/mac-screen-capture/*.node',
	'node_modules/.pnpm/@aethernet+mac-clipboard@*/node_modules/@aethernet/mac-clipboard/*.node',
	'node_modules/.pnpm/@aethernet+mac-sysctl@*/node_modules/@aethernet/mac-sysctl/*.node',
	'node_modules/.pnpm/@aethernet+mac-tcc@*/node_modules/@aethernet/mac-tcc/*.node',
	'node_modules/.pnpm/@aethernet+macos-input-hook@*/node_modules/@aethernet/macos-input-hook/*.node',
	'node_modules/.pnpm/@aethernet+platform-info@*/node_modules/@aethernet/platform-info/*.node',
	'node_modules/.pnpm/@aethernet+webauthn@*/node_modules/@aethernet/webauthn/*.node',
	'node_modules/.pnpm/@aethernet+webauthn@*/node_modules/@aethernet/webauthn/*.so*',
	'node_modules/.pnpm/@aethernet+hardware-encoder@*/node_modules/@aethernet/hardware-encoder/*.node',
];
const nativeBuildArtifactExcludes = [
	'!node_modules/@aethernet/**/src/**/*',
	'!node_modules/@aethernet/**/target/**/*',
	'!node_modules/@aethernet/**/build/**/*',
	'!node_modules/@aethernet/**/Cargo.toml',
	'!node_modules/@aethernet/**/Cargo.lock',
	'!node_modules/@aethernet/**/CMakeLists.txt',
	'!node_modules/@aethernet/**/tsconfig.json',
	'!node_modules/@aethernet/**/*.d.ts',
	'!node_modules/@aethernet/**/*.d.ts.map',
	'!node_modules/@aethernet/**/*.map',
	'!node_modules/@aethernet/**/*.rs',
	'!node_modules/@aethernet/**/*.swift',
];
...
const linuxDesktopEntry = {
	...
	Comment: isCanary ? 'Canary build of AETHERNET' : 'Instant messaging and VoIP',
	Keywords: 'chat;im;messaging;messenger;voip;voice;video;call;',
	Categories: 'Network;InstantMessaging;Chat;',
	StartupWMClass: linuxPackageName,
	StartupNotify: 'true',
	SingleMainWindow: 'true',
	MimeType: 'x-scheme-handler/aethernet;',
...
function windowsGameCaptureArtifactExcludes(arch) {
	const packageRoots = [
		'node_modules/@aethernet/win-game-capture',
		'node_modules/.pnpm/@aethernet+win-game-capture@*/node_modules/@aethernet/win-game-capture',
	];
...
function platformNativeExcludes(platform, arch) {
	const keepAethernetPackages = new Set(aethernetNativePackagesByPlatform[platform] ?? []);
	const aethernetPackageExcludes = aethernetNativePackages
		.filter((packageName) => !keepAethernetPackages.has(packageName))
		.flatMap((packageName) => [
			`!node_modules/${packageName}/**/*`,
			`!node_modules/.pnpm/${pnpmStoreDirName(packageName)}@*/**/*`,
		]);
	if (platform !== 'win32') {
		return [...aethernetPackageExcludes, '!node_modules/velopack/**/*'];
	}
...
function buildLinuxDesktopTaskExec(taskId) {
	return `${linuxInstalledExecPath} --aethernet-task=${taskId} %U`;
}
...
function addWindowsGameCaptureArtifacts(artifacts, tag) {
	artifacts.push({
		packageName: '@aethernet/win-game-capture',
...
function expectedNativeRuntimeArtifactsForArch(platform, arch) {
	...
	if (platform === 'darwin') {
		...
		artifacts.push({
			packageName: '@aethernet/linux-audio-capture',
			relativePath: `linux-audio-capture.${tag}.node`,
		});
		artifacts.push({
			packageName: '@aethernet/linux-portals',
			relativePath: `linux-portals.${tag}.node`,
		});
		artifacts.push({
			packageName: '@aethernet/linux-screen-capture',
			relativePath: `linux-screen-capture.${tag}.node`,
		});
		artifacts.push({
			packageName: '@aethernet/linux-notifications',
			relativePath: `linux-notifications.${tag}.node`,
		});
		artifacts.push({
			packageName: '@aethernet/linux-evdev',
			relativePath: `linux-evdev.${tag}.node`,
		});
		artifacts.push({
			packageName: '@aethernet/system-hunspell',
			relativePath: `system-hunspell.${tag}.node`,
		});
		artifacts.push({
			packageName: '@aethernet/linux-input-hook',
...
async function expectedNativeRuntimeArtifactsForAppDir(platform, arch, appDir) {
	...
	const webAuthnRoot = path.join(appDir, 'node_modules', '@aethernet', 'webauthn');
...
async function verifyNativePackageInputs(context) {
	if (process.env.AETHERNET_SKIP_NATIVE === 'true') return;
	...
	if (missing.length > 0) {
		throw new Error(
			[
				...
				'Run `pnpm build` from aethernet_desktop so native build outputs are synced into node_modules before electron-builder runs.',
			].join('\n'),
		);
	}
...
async function inspectAppImageLauncher(artifactPath) {
	const tempDir = await fs.mkdtemp(path.join(os.tmpdir(), 'aethernet-appimage-'));
	try {
...
module.exports = {
	appId,
	productName,
	copyright: 'Copyright © 2026 AETHERNET Contributors',
	...
	extraResources: [
		{
			...
			filter: [
				...
				'256x256.png',
				'512x512.png',
				'AethernetTrayTemplate.png',
				'AethernetTrayTemplate@2x.png',
				'icon.ico',
				'icon.png',
			],
		},
	...
	asar: {
		...
		unpack: [
			...
			'node_modules/.pnpm/@aethernet+linux-evdev@*/node_modules/@aethernet/linux-evdev/*.node',
			'node_modules/.pnpm/@aethernet+linux-input-hook@*/node_modules/@aethernet/linux-input-hook/*.node',
			'node_modules/.pnpm/@aethernet+system-hunspell@*/node_modules/@aethernet/system-hunspell/*.node',
			'node_modules/.pnpm/@aethernet+macos-input-hook@*/node_modules/@aethernet/macos-input-hook/*.node',
			'node_modules/.pnpm/@aethernet+mac-app-audio@*/node_modules/@aethernet/mac-app-audio/*.node',
			'node_modules/.pnpm/@aethernet+mac-screen-capture@*/node_modules/@aethernet/mac-screen-capture/*.node',
			'node_modules/.pnpm/@aethernet+mac-clipboard@*/node_modules/@aethernet/mac-clipboard/*.node',
	...
	mac: {
		...
		extendInfo: {
			NSMicrophoneUsageDescription: 'AETHERNET needs access to your microphone to enable voice chat features.',
			NSCameraUsageDescription: 'AETHERNET needs access to your camera to enable video chat features.',
			NSAppleEventsUsageDescription: 'AETHERNET needs access to Apple Events for automation features.',
			NSAudioCaptureUsageDescription: 'AETHERNET captures audio from the screen or window you choose to share.',
			NSScreenCaptureUsageDescription: 'AETHERNET captures the screen or window you choose to share.',
		},
	},
	dmg: {
		contents: [
