...
const ACTIVE_ALLOW_TRANSPARENCY_RENDERER_ARG = '--aethernet-active-allow-transparency=1';
const ACTIVE_USE_NATIVE_TITLEBAR_RENDERER_ARG = '--aethernet-active-use-native-titlebar=1';
const INSECURE_ORIGIN_RENDERER_ARG_PREFIX = '--unsafely-treat-insecure-origin-as-secure=';
const THEME_STUDIO_POPOUT_WINDOW_NAME = 'aethernet_theme_studio';
const THEME_STUDIO_POPOUT_PATHNAME = '/theme-studio';
const THEME_STUDIO_POPOUT_TITLE = 'AETHERNET | Theme Studio';
...
const VOICE_POPOUT_WINDOW_NAME_PREFIX = 'aethernet-voice-popout:';
...
const POPOUT_NAMESPACE = 'aethernet_';
