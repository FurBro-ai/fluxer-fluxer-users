...
const UPDATE_API_ENDPOINT =
	BUILD_CHANNEL === 'canary' ? 'https://api.canary.aethernet.app' : 'https://api.aethernet.app';
...
export const DOWNLOAD_PAGE_URL =
	BUILD_CHANNEL === 'canary' ? 'https://canary.aethernet.app/download' : 'https://aethernet.app/download';
...
function getArtifactProductName(): string {
	return BUILD_CHANNEL === 'canary' ? 'Aethernet-Canary' : 'Aethernet';
}
