...
const SKIP_PREFLIGHT_ENV = 'AETHERNET_SKIP_NATIVE_PREFLIGHT';
...
const NATIVE_MODULE_PREFLIGHT_SPECS: ReadonlyArray<NativeModulePreflightSpec> = [
	{
		name: '@aethernet/webauthn',
		platforms: new Set(['darwin', 'linux', 'win32']),
	},
	{
		name: '@aethernet/platform-info',
		platforms: new Set(['darwin', 'linux', 'win32']),
	},
	{
		name: '@aethernet/mac-app-audio',
		platforms: new Set(['darwin']),
	},
	{
		name: '@aethernet/mac-clipboard',
		platforms: new Set(['darwin']),
	},
	{
		name: '@aethernet/mac-sysctl',
		platforms: new Set(['darwin']),
	},
	{
		name: '@aethernet/mac-tcc',
		platforms: new Set(['darwin']),
	},
	{
		name: '@aethernet/macos-input-hook',
		platforms: new Set(['darwin']),
	},
	{
		name: '@aethernet/linux-audio-capture',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/linux-evdev',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/linux-input-hook',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/linux-notifications',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/linux-portals',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/linux-screen-capture',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/system-hunspell',
		platforms: new Set(['linux']),
	},
	{
		name: '@aethernet/win-clipboard',
		platforms: new Set(['win32']),
	},
	{
		name: '@aethernet/win-process-loopback',
		platforms: new Set(['win32']),
	},
	{
		name: '@aethernet/win-shell',
		platforms: new Set(['win32']),
	},
	{
		name: '@aethernet/win-toast',
		platforms: new Set(['win32']),
	},
	{
		name: '@aethernet/windows-input-hook',
		platforms: new Set(['win32']),
	},
];
const PROBE_SCRIPT = `
...
function probeAllModules(resolved: Array<ResolvedSpec>): ProbeOutcome {
	...
	const result = spawnSync(process.execPath, ['-e', PROBE_SCRIPT, ...resolved.map((entry) => entry.modulePath)], {
		env: {
			...
			AETHERNET_NATIVE_MODULE_PREFLIGHT_CHILD: '1',
		},
		encoding: 'utf8',
...
export function runNativeModulePreflight(): void {
	...
	throw new Error(`Aethernet native module preflight failed on ${process.platform}/${process.arch}.\n${details}`);
}
