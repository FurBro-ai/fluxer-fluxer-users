...
is_clustered_false_when_flag_not_true_test() ->
    persistent_term:put({aethernet_gateway, runtime_config}, #{cluster_enabled => false}),
    ?assertEqual(false, gateway_rollout_config:is_clustered()),
    persistent_term:put({aethernet_gateway, runtime_config}, #{cluster_enabled => <<"true">>}),
    ?assertEqual(false, gateway_rollout_config:is_clustered()),
    persistent_term:put({aethernet_gateway, runtime_config}, #{cluster_enabled => 1}),
    ?assertEqual(false, gateway_rollout_config:is_clustered()).
