...
snowflake_uses_aethernet_response_shape_test() ->
...
int_fields_follow_aethernet_non_negative_int32_schema_test() ->
    Guild = #{
        <<"id">> => <<"10">>,
        <<"owner_id">> => <<"20">>,
        <<"member_count">> => <<"0">>,
...
guild_normalizes_only_aethernet_response_snowflakes_test() ->
    Guild = #{
        <<"id">> => <<"10">>,
        <<"owner_id">> => <<"20">>,
...
channel_overwrites_keep_only_aethernet_schema_fields_test() ->
    Channel = normalized_channel(#{
        <<"id">> => <<"100">>,
        <<"permission_overwrites">> => [
            #{
