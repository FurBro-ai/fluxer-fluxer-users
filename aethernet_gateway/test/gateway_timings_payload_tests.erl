...
finalize_sanitizes_legacy_runtime_metadata_test() ->
    RemoteNode = 'aethernet_gateway@10.0.0.91',
...
finalize_omits_legacy_child_remote_metadata_test() ->
    RemoteNode = 'aethernet_gateway@10.0.0.92',
...
sanitize_message_rewrites_ready_timings_without_reordering_trace_test() ->
    RemoteNode = 'aethernet_gateway@10.0.0.93',
...
sanitize_message_rewrites_resumed_timings_test() ->
    RemoteNode = 'aethernet_gateway@10.0.0.94',
...
legacy_recorder(RemoteNode) ->
    #{
        ...
        started_node => 'aethernet_gateway@10.0.0.90',
        steps => #{},
        nodes => [],
        trace => [
        ...
        erlang_node_name => <<"aethernet_gateway@10.0.0.90">>,
        role => <<"websocket">>
    }.
