...
-module(aethernet_gateway_app_tests).
-typing([eqwalizer]).
...
vm_fullsweep_after_values() ->
    {aethernet_gateway_app, Beam, _Path} = code:get_object_code(aethernet_gateway_app),
    {ok, {aethernet_gateway_app, [{abstract_code, {raw_abstract_v1, Forms}}]}} =
