...
with_ttl_env(Value, Fun) ->
    application:set_env(aethernet_gateway, push_blocked_ids_cache_ttl_seconds, Value),
    try
        Fun()
    after
        application:unset_env(aethernet_gateway, push_blocked_ids_cache_ttl_seconds)
    end.
