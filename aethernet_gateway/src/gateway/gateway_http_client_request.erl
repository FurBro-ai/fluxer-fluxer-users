...
memoisable_urls() ->
    [
        ...
        <<"https://fcm.googleapis.com/v1/projects/aethernet/messages:send">>,
...
url_metadata_values_test() ->
    ?assertEqual(
        [
            {<<"aethernet-api.aethernet.svc.cluster.local">>, false},
            {<<"fcm.googleapis.com">>, true},
            {<<"aethernet-api.aethernet.svc.cluster.local">>, false},
            {<<"aethernet-api.aethernet.svc.cluster.local">>, true}
        ],
