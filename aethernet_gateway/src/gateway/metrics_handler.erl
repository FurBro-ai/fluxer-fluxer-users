...
render_gateway_gauges() ->
    ...
    [
        format_metric(
            <<"aethernet_gateway_sessions_total">>,
            <<"gauge">>,
            <<"Connected WebSocket sessions">>,
            integer_to_binary(Sessions)
        ),
        format_metric(
            <<"aethernet_gateway_guilds_total">>,
            <<"gauge">>,
...
render_voice_metrics(Counts) when map_size(Counts) =:= 0 ->
    format_metric(
        <<"aethernet_gateway_voice_connections_total">>,
        <<"gauge">>,
...
render_voice_metrics(Counts) ->
    ...
    [
        ...
        format_labeled_series(
            <<"aethernet_gateway_voice_connections">>,
            <<"gauge">>,
...
render_cluster_counters() ->
    ...
    case map_size(Snapshot) of
        ...
        _ ->
            ...
            [
                format_metric(
                    <<"aethernet_gateway_cluster_member_count">>,
                    <<"gauge">>,
                    <<"Alive cluster members">>,
                    integer_to_binary(MemberCount)
                ),
                format_metric(
                    <<"aethernet_gateway_cluster_discovery_resolve_failures_total">>,
                    <<"counter">>,
                    <<"DNS discovery resolve failures">>,
                    integer_to_binary(DiscoveryFailures)
                ),
                format_labeled_series(
                    <<"aethernet_gateway_cluster_membership_transitions_total">>,
                    <<"counter">>,
                ...
                format_labeled_series(
                    <<"aethernet_gateway_cluster_owner_resolutions_total">>,
                    <<"counter">>,
...
render_push_dispatcher_stats() ->
    ...
    case map_size(Stats) of
        ...
        _ ->
            ...
            [
                format_metric(
                    <<"aethernet_gateway_push_dispatcher_queued">>,
                    <<"gauge">>,
                    <<"Push dispatcher queued jobs">>,
                    integer_to_binary(Queued)
                ),
                format_metric(
                    <<"aethernet_gateway_push_dispatcher_inflight">>,
                    <<"gauge">>,
