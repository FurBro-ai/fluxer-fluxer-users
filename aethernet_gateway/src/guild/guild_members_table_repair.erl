...
self_heal_enabled() ->
    application:get_env(aethernet_gateway, guild_members_table_self_heal, true) =:= true.
...
with_self_heal_enabled(Fun) ->
    ok = application:set_env(aethernet_gateway, guild_members_table_self_heal, true),
    try
        Fun()
    after
        application:unset_env(aethernet_gateway, guild_members_table_self_heal)
    end.
