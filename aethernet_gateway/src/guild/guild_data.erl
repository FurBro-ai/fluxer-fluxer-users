...
with_trim_threshold(Threshold, Fun) ->
    application:set_env(aethernet_gateway, connect_snapshot_trim_member_threshold, Threshold),
    try
        Fun()
    after
        application:unset_env(aethernet_gateway, connect_snapshot_trim_member_threshold)
    end.
