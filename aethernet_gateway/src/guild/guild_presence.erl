...
presence_snapshot_trim_enabled() ->
    case application:get_env(aethernet_gateway, presence_snapshot_trim_enabled, true) of
        false -> false;
        _ -> true
    end.
...
build_broadcast_snapshot_trims_by_default_test() ->
    application:set_env(aethernet_gateway, presence_snapshot_trim_member_threshold, 2),
    ...
    after
        application:unset_env(aethernet_gateway, presence_snapshot_trim_member_threshold),
        ets:delete(Tab)
    end.

build_broadcast_snapshot_no_trim_when_disabled_test() ->
    application:set_env(aethernet_gateway, presence_snapshot_trim_enabled, false),
    ...
    after
        application:unset_env(aethernet_gateway, presence_snapshot_trim_enabled),
        ets:delete(Tab)
    end.

build_broadcast_snapshot_no_trim_below_threshold_test() ->
    application:set_env(aethernet_gateway, presence_snapshot_trim_member_threshold, 50000),
