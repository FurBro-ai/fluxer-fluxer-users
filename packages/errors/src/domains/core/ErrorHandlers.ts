...
import {Locales} from '@aethernet/constants/src/Locales';
import {AethernetError} from '@aethernet/errors/src/AethernetError';
import {OAuth2Error} from '@aethernet/errors/src/domains/auth/OAuth2Error';
import {
...
} from '@aethernet/errors/src/error_handling/ErrorIntrospection';
import {createJsonErrorResponse} from '@aethernet/errors/src/error_handling/ErrorResponse';
import {ErrorCodeToI18nKey} from '@aethernet/errors/src/i18n/ErrorCodeMappings';
import {getErrorMessageUnsafe} from '@aethernet/errors/src/i18n/ErrorI18n';
import type {ErrorI18nKey} from '@aethernet/errors/src/i18n/ErrorI18nMessages';
import type {BaseHonoEnv, ErrorI18nService} from '@aethernet/hono_types/src/HonoTypes';
import {createLogger} from '@aethernet/logger/src/Logger';
...
function handleAethernetError<E extends BaseHonoEnv>(err: AethernetError, ctx: Context<E>): Response {
...
function resolveErrorResponse<E extends BaseHonoEnv>(err: Error, ctx: Context<E>): ResolvedErrorResponse {
	...
	if (err instanceof AethernetError) {
		return {response: handleAethernetError(err, ctx), unexpected: false};
	}
