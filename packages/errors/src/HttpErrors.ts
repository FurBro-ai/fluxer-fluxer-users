...
export class BadRequestError extends AethernetError {
...
export class NotFoundError extends AethernetError {
	constructor(options: HttpErrorOptions = {}) {
		super({
			...options,
...
export class MethodNotAllowedError extends AethernetError {
	constructor(options: HttpErrorOptions = {}) {
		super({
			...options,
...
export class GoneError extends AethernetError {
	constructor(options: HttpErrorOptions = {}) {
		super({
			...options,
...
export class NotImplementedError extends AethernetError {
	constructor(options: HttpErrorOptions = {}) {
		super({
			...options,
