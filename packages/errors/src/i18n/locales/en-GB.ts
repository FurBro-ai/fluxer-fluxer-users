...
const ERROR_I18N_EN_GB_MESSAGES = defineErrorI18nLocaleMessages({
	...
	"permissions.global_ip_banned": "Your IP address {ipAddress} has been permanently blocked from the Aethernet API by platform administrators. If you believe this is a mistake, contact support@aethernet.app to appeal. Include this IP address in your appeal.",
	"permissions.global_ip_temporarily_banned": "Your IP address {ipAddress} has been temporarily blocked from the Aethernet API for 24 hours because of abusive or unusual access patterns. We usually do not provide appeals for temporary API bans. Change IP addresses or wait for the ban to expire, and review the Aethernet API access patterns coming from your client.",
	...
	"phone.country_not_supported": "We don't send verification texts to this country. Use a mobile number from another country, or email support@aethernet.app and a person will review your account.",
	...
	"phone.number_not_in_service": "Your mobile network says this number isn't in service. Check the number and try again, or email support@aethernet.app if it's correct.",
	"phone.number_not_mobile": "This isn't a mobile number, so it can't receive our text. Use a mobile number, or email support@aethernet.app if you think that's wrong.",
	"phone.verification_code_invalid": "Invalid phone verification code.",
	"phone.verification_needs_review": "We couldn't verify this number automatically. Email support@aethernet.app and a person will review your account.",
	...
	"usernames_and_tags.username_reserved_terms": "Username can't contain \"aethernet\" or \"system message\".",
	...
	"vanity_urls.vanity_url_code_cannot_contain_aethernet": "Vanity URL code can't contain \"aethernet\".",
