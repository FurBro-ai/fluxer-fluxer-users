...
import {
	...
	hasErrorLocale,
} from '@aethernet/errors/src/i18n/ErrorI18n';
import type {ErrorI18nKey} from '@aethernet/errors/src/i18n/ErrorI18nTypes.generated';
...
describe('ErrorI18n', () => {
	...
	describe('phone rejection messages', () => {
		...
		it.each([
			...
			expect(getErrorMessageUnsafe(code, 'en-US')).toContain('support@aethernet.app');
		});
