...
import {ERROR_I18N_LOCALE_MESSAGES} from '@aethernet/errors/src/i18n/ErrorI18nLocales';
import {
	ERROR_I18N_MESSAGES,
	type ErrorI18nCatalog,
	type ErrorI18nKey,
} from '@aethernet/errors/src/i18n/ErrorI18nMessages';
import {identityLocale} from '@aethernet/i18n/src/normalization/IdentityLocale';
import {createStaticI18n} from '@aethernet/i18n/src/runtime/CreateStaticI18n';
import type {I18nResult} from '@aethernet/i18n/src/runtime/I18nTypes';
import type {
	MessageArgsForTemplate,
	MessageArgsWithFallbackForTemplate,
} from '@aethernet/i18n/src/runtime/MessageCatalogTypes';
import {validateMessageTemplateVariables} from '@aethernet/i18n/src/runtime/MessageCatalogTypes';
