...
export const ERROR_I18N_MESSAGES = {
	...
	'permissions.global_ip_banned':
		'Your IP address {ipAddress} has been permanently blocked from the Aethernet API by platform administrators. If you believe this is a mistake, contact support@aethernet.app to appeal. Include this IP address in your appeal.',
	'permissions.global_ip_temporarily_banned':
		'Your IP address {ipAddress} has been temporarily blocked from the Aethernet API for 24 hours because of abusive or unusual access patterns. We usually do not provide appeals for temporary API bans. Change IP addresses or wait for the ban to expire, and review the Aethernet API access patterns coming from your client.',
