...
import {getErrorMessage} from '@aethernet/errors/src/i18n/ErrorI18n';
...
describe('AppErrorHandler i18n fallbacks', () => {
	...
	it('localizes AethernetError responses without an i18n service and logs them as expected rejections', async () => {
		const errorLogger = vi.spyOn(Logger.prototype, 'error').mockImplementation(() => {});
