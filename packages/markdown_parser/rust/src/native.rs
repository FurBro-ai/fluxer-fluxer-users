...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aethernet_md_parse(
    input_ptr: *const u8,
    input_len: usize,
    flags: u32,
    tsv_ptr: *const u8,
    tsv_len: usize,
    out: *mut AethernetMdBuffer,
) -> u32 {
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aethernet_md_parse_binary(
    input_ptr: *const u8,
    input_len: usize,
    flags: u32,
    tsv_ptr: *const u8,
...
#[allow(clippy::missing_safety_doc)]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn aethernet_md_buffer_free(out: *mut AethernetMdBuffer) {
    if out.is_null() {
        return;
    }
...
unsafe fn write_data(out: *mut AethernetMdBuffer, bytes: Vec<u8>) -> u32 {
    unsafe {
        *out = AethernetMdBuffer {
            data_len: bytes.len(),
            data: leak(bytes),
...
unsafe fn write_error(out: *mut AethernetMdBuffer, message: &str) -> u32 {
