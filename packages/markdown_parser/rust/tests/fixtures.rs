...
use aethernet_markdown_parser::{EmojiContext, MarkdownParser, ParserFlags};
...
fn native_parser_allows_app_protocol_links() {
    ...
    assert_eq!(
        parse(
            "aethernet://invite/abc aethernet:/channels/123/456 [Open gift](aethernet:gift/xyz)",
            flags,
            ""
        ),
        json!({"nodes":[
            {
                "type":"Link",
                "url":"aethernet://invite/abc",
                "escaped":false,
                "rawUrl":"aethernet://invite/abc",
                "source":"aethernet://invite/abc"
            },
            {"type":"Text","content":" "},
            {
                "type":"Link",
                "url":"aethernet:/channels/123/456",
                "escaped":false,
                "rawUrl":"aethernet:/channels/123/456",
                "source":"aethernet:/channels/123/456"
            },
            {"type":"Text","content":" "},
            {
                "type":"Link",
                "text":{"type":"Text","content":"Open gift"},
                "url":"aethernet:gift/xyz",
                "escaped":false,
                "rawUrl":"aethernet:gift/xyz",
                "source":"[Open gift](aethernet:gift/xyz)"
            }
        ]})
    );
}
