...
import type {CacheHeadersOptions} from '@aethernet/hono/src/middleware/CacheHeaders';
import {cacheHeaders} from '@aethernet/hono/src/middleware/CacheHeaders';
import type {CorsOptions} from '@aethernet/hono/src/middleware/Cors';
import {cors} from '@aethernet/hono/src/middleware/Cors';
import type {ErrorHandlerOptions} from '@aethernet/hono/src/middleware/ErrorHandler';
import {createErrorHandler} from '@aethernet/hono/src/middleware/ErrorHandler';
import type {RateLimitOptions, RateLimitService} from '@aethernet/hono/src/middleware/RateLimit';
import {rateLimit} from '@aethernet/hono/src/middleware/RateLimit';
import type {RequestIdOptions} from '@aethernet/hono/src/middleware/RequestId';
import {requestId} from '@aethernet/hono/src/middleware/RequestId';
import type {LogFunction, RequestLoggerOptions} from '@aethernet/hono/src/middleware/RequestLogger';
import {requestLogger} from '@aethernet/hono/src/middleware/RequestLogger';
import {aethernetVersionHeader} from '@aethernet/hono/src/middleware/VersionHeader';
...
export function createStandardMiddlewareStack(options: MiddlewareStackOptions = {}): Array<MiddlewareHandler> {
	const stack: Array<MiddlewareHandler> = [aethernetVersionHeader()];
