...
import {extractPathParameterNames} from '@aethernet/openapi/src/extractors/PathParameters';
import type {
	ExtractedRoute,
	OpenAPIOperation,
	OpenAPIParameter,
...
import {getErrorResponses} from '@aethernet/openapi/src/registry/ResponseRegistry';
