...
import type {OpenAPIResponse, OpenAPISchema} from '@aethernet/openapi/src/OpenAPITypes';
import {ErrorResponse, ThrottledErrorResponse} from '@aethernet/schema/src/domains/common/ErrorSchemas';
import {z} from 'zod';
