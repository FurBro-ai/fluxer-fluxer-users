...
import {convertPathToOpenAPI, extractPathParameterNames} from '@aethernet/openapi/src/extractors/PathParameters';
...
import type {ExtractedRoute} from '@aethernet/openapi/src/OpenAPITypes';
import {SchemaRegistry} from '@aethernet/openapi/src/registry/SchemaRegistry';
import {DonationManageQuery} from '@aethernet/schema/src/domains/donation/DonationSchemas';
import {beforeAll, describe, expect, it} from 'vitest';

const API_PACKAGE_PATH = path.join(fileURLToPath(new URL('../../../../../', import.meta.url)), 'aethernet_api');
