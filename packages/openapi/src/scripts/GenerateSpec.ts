...
import type {OpenAPIGenerationStats, SkippedRoute} from '@aethernet/openapi/src/OpenAPIGenerationTypes';
import {OpenAPIGenerator} from '@aethernet/openapi/src/OpenAPIGenerator';
import {printValidationResult, validateSpec} from '@aethernet/openapi/src/output/SpecValidator';
import {
	getAdminOutputPath,
	...
	writeSpec,
} from '@aethernet/openapi/src/output/SpecWriter';
...
const API_DESCRIPTION =
	'API for Aethernet, a free and open source instant messaging and VoIP chat app built for friends, groups, and communities.';
...
async function buildTargetSpec(basePath: string, target: GenerateTarget): Promise<WritableOpenAPISpec> {
	const generator = new OpenAPIGenerator({
		...
		serverUrl: 'https://api.aethernet.app/v1',
		routeScope: target,
...
async function main(): Promise<void> {
	...
	console.log('Aethernet OpenAPI Specification Generator');
	console.log('======================================');
