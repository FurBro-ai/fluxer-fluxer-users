...
import {createStringType, Int32Type} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';

export const GIF_PROVIDER_HEADER = 'X-Aethernet-GIF-Provider';
export const GIF_PROVIDER_DISPLAY_NAME_HEADER = 'X-Aethernet-GIF-Provider-Display-Name';
export const GIF_PROVIDER_ATTRIBUTION_HEADER = 'X-Aethernet-GIF-Provider-Attribution-Required';
