...
import {MAX_GIFT_CODES_PER_REQUEST, MAX_GIFT_DURATION_QUANTITY} from '@aethernet/constants/src/GiftCodeConstants';
import {
	CONTENT_WARNING_TEXT_MAX_LENGTH,
	SystemChannelFlags,
	SystemChannelFlagsDescriptions,
} from '@aethernet/constants/src/GuildConstants';
import {LIMIT_KEYS} from '@aethernet/constants/src/LimitConfigMetadata';
import {ADMIN_ACL_COUNT, AdminAclType} from '@aethernet/schema/src/domains/admin/AdminAclType';
import {AdminArchiveResponseSchema} from '@aethernet/schema/src/domains/admin/AdminArchiveSchemas';
import {GuildAdminResponse} from '@aethernet/schema/src/domains/admin/AdminGuildSchemas';
import {UserAdminResponseSchema} from '@aethernet/schema/src/domains/admin/AdminUserSchemas';
import {
	GatewayRolloutConfigResponse,
	GatewayRolloutConfigUpdateRequest,
} from '@aethernet/schema/src/domains/admin/GatewayRolloutSchemas';
import {
...
} from '@aethernet/schema/src/domains/experiment/ExperimentSchemas';
import {GuildMemberResponse} from '@aethernet/schema/src/domains/guild/GuildMemberSchemas';
import {
	InstanceCaptchaProviderSchema,
	InstanceRegistrationModeSchema,
} from '@aethernet/schema/src/domains/instance/InstanceSchemas';
import {MessageResponseSchema} from '@aethernet/schema/src/domains/message/MessageResponseSchemas';
import {GiftCodeDurationTypeSchema} from '@aethernet/schema/src/domains/premium/GiftCodeSchemas';
import {ChannelTypeSchema} from '@aethernet/schema/src/primitives/ChannelValidators';
import {
	...
	NSFWLevelSchema,
} from '@aethernet/schema/src/primitives/GuildValidators';
import {PermissionStringType} from '@aethernet/schema/src/primitives/PermissionValidators';
import {createQueryIntegerType, QueryBooleanType} from '@aethernet/schema/src/primitives/QueryValidators';
import {
	...
	SnowflakeType,
	withOpenApiType,
} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {EmailType} from '@aethernet/schema/src/primitives/UserValidators';
import {z} from 'zod';
