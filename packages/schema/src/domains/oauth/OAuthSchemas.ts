...
import {ApplicationFlags, BotFlags, BotFlagsDescriptions} from '@aethernet/constants/src/BotConstants';
import {AVATAR_MAX_SIZE, MAX_APPLICATION_REDIRECT_URIS} from '@aethernet/constants/src/LimitConstants';
import {PublicUserFlags, PublicUserFlagsDescriptions} from '@aethernet/constants/src/UserConstants';
import {UserPartialResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
...
import {UserAuthenticatorTypesSchema} from '@aethernet/schema/src/primitives/UserSettingsValidators';
import {DiscriminatorType, UsernameType} from '@aethernet/schema/src/primitives/UserValidators';
import {z} from 'zod';
