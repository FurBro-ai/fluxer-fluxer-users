...
import type {GuildMemberData} from '@aethernet/schema/src/domains/guild/GuildMemberSchemas';
import {type MessageEmbed, MessageEmbedResponse} from '@aethernet/schema/src/domains/message/EmbedSchemas';
import {type UserPartial, UserPartialResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
import {MessageReferenceTypeSchema, MessageTypeSchema} from '@aethernet/schema/src/primitives/MessageValidators';
import {
