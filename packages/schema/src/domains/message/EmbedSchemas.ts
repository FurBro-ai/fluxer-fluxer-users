...
import {EmbedMediaFlags, EmbedMediaFlagsDescriptions} from '@aethernet/constants/src/ChannelConstants';
import {createBitflagInt32Type, Int32Type} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
