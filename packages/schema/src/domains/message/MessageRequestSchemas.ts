...
import {MessageFlags, MessageFlagsDescriptions} from '@aethernet/constants/src/ChannelConstants';
import {MAX_MESSAGE_LENGTH_NON_PREMIUM, MAX_MESSAGE_LENGTH_PREMIUM} from '@aethernet/constants/src/LimitConstants';
import {
	ClientAttachmentReferenceRequest,
	ClientAttachmentRequest,
	ClientUploadedAttachmentRequest,
} from '@aethernet/schema/src/domains/message/AttachmentSchemas';
import {
	AllowedMentionsRequest,
	MessageReferenceRequest,
} from '@aethernet/schema/src/domains/message/SharedMessageSchemas';
import {createQueryIntegerType, DateTimeType} from '@aethernet/schema/src/primitives/QueryValidators';
import {
	ColorType,
...
import {AttachmentURLType, URLType} from '@aethernet/schema/src/primitives/UrlValidators';
import {z} from 'zod';
