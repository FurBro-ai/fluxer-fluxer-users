...
import {MAX_INVITE_AGE_SECONDS, MAX_INVITE_USES} from '@aethernet/constants/src/LimitConstants';
import {type Channel, ChannelPartialResponse} from '@aethernet/schema/src/domains/channel/ChannelSchemas';
import {type Guild, GuildPartialResponse} from '@aethernet/schema/src/domains/guild/GuildResponseSchemas';
import {UserPartialResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
import {Int32Type} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
