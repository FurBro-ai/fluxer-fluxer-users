...
} from '@aethernet/schema/src/domains/auth/WebAuthnSchemas';
...
const PhoneSendVerificationInboundChallengeResponse = z.object({
	channel: z.literal('inbound_challenge').describe('The user must send Aethernet an SMS instead of receiving one'),
