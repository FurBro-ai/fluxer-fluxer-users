...
import {RTC_REGION_ID_MAX_LENGTH, RTC_REGION_ID_MIN_LENGTH} from '@aethernet/constants/src/LimitConstants';
import {GatewayRolloutConfigResponse} from '@aethernet/schema/src/domains/admin/GatewayRolloutSchemas';
import {WebAuthnCredentialResponse} from '@aethernet/schema/src/domains/auth/AuthSchemas';
import {ChannelResponse, RtcRegionResponse} from '@aethernet/schema/src/domains/channel/ChannelSchemas';
import {VoiceStateResponse} from '@aethernet/schema/src/domains/gateway/GatewaySchemas';
import {GuildEmojiResponse, GuildStickerResponse} from '@aethernet/schema/src/domains/guild/GuildEmojiSchemas';
import {GuildMemberResponse} from '@aethernet/schema/src/domains/guild/GuildMemberSchemas';
import {GuildResponse} from '@aethernet/schema/src/domains/guild/GuildResponseSchemas';
import {GuildRoleResponse} from '@aethernet/schema/src/domains/guild/GuildRoleSchemas';
import {FavoriteMemeResponse} from '@aethernet/schema/src/domains/meme/MemeSchemas';
import {CustomStatusPayload} from '@aethernet/schema/src/domains/user/UserRequestSchemas';
import {
...
} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
import {
	createStringType,
	SnowflakeStringType,
	SnowflakeType,
