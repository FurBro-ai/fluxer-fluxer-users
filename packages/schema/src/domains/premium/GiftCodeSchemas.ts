...
import {GIFT_CODE_DURATION_TYPE_DEFINITIONS} from '@aethernet/constants/src/GiftCodeConstants';
import {UserPartialResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
import {createNamedStringLiteralUnion, createStringType} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
