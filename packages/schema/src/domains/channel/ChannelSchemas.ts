...
import {MAX_GROUP_DM_OTHER_RECIPIENTS, MAX_GROUP_DM_RECIPIENTS} from '@aethernet/constants/src/LimitConstants';
import {type UserPartial, UserPartialResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
import {ChannelOverwriteTypeSchema, ChannelTypeSchema} from '@aethernet/schema/src/primitives/ChannelValidators';
...
import {createStringType, Int32Type, SnowflakeStringType} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
