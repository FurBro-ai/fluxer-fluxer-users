...
import {AVATAR_MAX_SIZE, MAX_MESSAGE_LENGTH_PREMIUM} from '@aethernet/constants/src/LimitConstants';
import {ClientUploadedAttachmentRequest} from '@aethernet/schema/src/domains/message/AttachmentSchemas';
import {
	MessageContentRequest,
	MessageNonceRequest,
	RichEmbedRequest,
} from '@aethernet/schema/src/domains/message/MessageRequestSchemas';
import {
	AllowedMentionsRequest,
	MessageReferenceRequest,
} from '@aethernet/schema/src/domains/message/SharedMessageSchemas';
...
import {WebhookNameType} from '@aethernet/schema/src/primitives/UserValidators';
import {z} from 'zod';
