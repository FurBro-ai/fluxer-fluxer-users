...
import {AccessibilitySettingsSchema} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/accessibility_pb';
import {
	FavoriteGifSettingsSchema,
	SoundSettingsSchema,
} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/pickers_pb';
import {ChatInputSettingsSchema} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/preferences_pb';
