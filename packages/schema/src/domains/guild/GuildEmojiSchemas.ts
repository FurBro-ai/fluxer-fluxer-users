...
import {MAX_GUILD_STICKER_TAGS} from '@aethernet/constants/src/LimitConstants';
import {type UserPartial, UserPartialResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
import {SnowflakeStringType} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
