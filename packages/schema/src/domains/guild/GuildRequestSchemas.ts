...
import {GuildFeatureSchema} from '@aethernet/schema/src/domains/guild/GuildResponseSchemas';
import {TemplateSerializedGuild} from '@aethernet/schema/src/domains/guild/GuildTemplateSchemas';
import {VanityURLCodeType} from '@aethernet/schema/src/primitives/ChannelValidators';
...
import {QueryBooleanType} from '@aethernet/schema/src/primitives/QueryValidators';
import {
	ColorType,
...
import {MentionReplyPreferencesSchema} from '@aethernet/schema/src/primitives/UserSettingsValidators';
import {PasswordType} from '@aethernet/schema/src/primitives/UserValidators';
import {z} from 'zod';
