...
} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/preferences_pb';
import {create, fromBinary, toBinary, toJson} from '@bufbuild/protobuf';
import {base64ToUint8Array, uint8ArrayToBase64} from 'uint8array-extras';

export type {SyncedPreferences} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/preferences_pb';
export {SyncedPreferencesSchema} from '@aethernet/schema/src/gen/aethernet/user/preferences/v1/preferences_pb';
