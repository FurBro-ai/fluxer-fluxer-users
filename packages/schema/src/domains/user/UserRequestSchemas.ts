...
import {StatusTypes} from '@aethernet/constants/src/StatusConstants';
import {
...
import {SudoVerificationSchema} from '@aethernet/schema/src/domains/auth/AuthSchemas';
import {
	isValidSyncedPreferencesEncoding,
	SYNCED_PREFERENCES_MAX_ENCODED_LENGTH,
} from '@aethernet/schema/src/domains/user/SyncedPreferencesCodec';
import {isValidSingleUnicodeEmoji} from '@aethernet/schema/src/primitives/EmojiValidators';
import {base64LengthForBytes, createBase64StringType} from '@aethernet/schema/src/primitives/FileValidators';
import {LocaleSchema} from '@aethernet/schema/src/primitives/LocaleSchema';
import {createQueryIntegerType, DateTimeType, QueryBooleanType} from '@aethernet/schema/src/primitives/QueryValidators';
import {
	ColorType,
...
import {URLType} from '@aethernet/schema/src/primitives/UrlValidators';
import {
...
} from '@aethernet/schema/src/primitives/UserSettingsValidators';
import {
	DiscriminatorType,
	EmailType,
	GlobalNameType,
	PasswordType,
	UsernameType,
} from '@aethernet/schema/src/primitives/UserValidators';
import {z} from 'zod';
