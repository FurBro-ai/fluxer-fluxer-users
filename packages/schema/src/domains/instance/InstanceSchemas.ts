...
import {SsoStatusResponse} from '@aethernet/schema/src/domains/auth/AuthSchemas';
import {createNamedStringLiteralUnion} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
...
export const WellKnownAethernetResponse = z.object({
...
export type WellKnownAethernetResponse = z.infer<typeof WellKnownAethernetResponse>;
