...
const CATALOGS: Array<StaticCatalogConfig> = [
	...
	},
	{
		name: 'email',
		kind: 'email',
		sourceModulePath: path.join(REPO_ROOT, 'aethernet_api/pkgs/email/src/email_i18n/EmailI18nMessages.ts'),
		sourceExportName: 'EMAIL_I18N_MESSAGES',
		weblateDir: path.join(REPO_ROOT, 'aethernet_api/pkgs/email/src/email_i18n/weblate'),
		localeTsDir: path.join(REPO_ROOT, 'aethernet_api/pkgs/email/src/email_i18n/locales'),
	...
	},
	{
		name: 'content',
		kind: 'flat',
		sourceModulePath: path.join(REPO_ROOT, 'aethernet_api/src/api/content_i18n/ContentI18nMessages.ts'),
		sourceExportName: 'CONTENT_I18N_MESSAGES',
		weblateDir: path.join(REPO_ROOT, 'aethernet_api/src/api/content_i18n/weblate'),
		localeTsDir: path.join(REPO_ROOT, 'aethernet_api/src/api/content_i18n/locales'),
