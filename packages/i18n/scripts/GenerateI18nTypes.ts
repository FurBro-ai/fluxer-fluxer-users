...
const PACKAGES: Array<PackageConfig> = [
	{
		name: '@pkgs/email',
		localesPath: path.join(REPO_ROOT, 'aethernet_api/pkgs/email/src/email_i18n/locales'),
		outputFile: path.join(REPO_ROOT, 'aethernet_api/pkgs/email/src/email_i18n/EmailI18nTypes.generated.ts'),
		isEmail: true,
		staticMessagesModule: path.join(REPO_ROOT, 'aethernet_api/pkgs/email/src/email_i18n/EmailI18nMessages.ts'),
