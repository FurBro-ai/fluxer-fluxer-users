...
import {getEffectiveLocale} from '@aethernet/i18n/src/runtime/GetEffectiveLocale';
import type {I18nResult, I18nState, TemplateCompiler} from '@aethernet/i18n/src/runtime/I18nTypes';
import {loadLocaleIfNotLoaded} from '@aethernet/i18n/src/runtime/LoadLocale';
import {renderTemplate} from '@aethernet/i18n/src/runtime/RenderTemplate';
