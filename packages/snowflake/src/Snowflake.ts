...
export const AETHERNET_EPOCH = BigInt(AETHERNET_EPOCH_NUMBER);
...
function getTimestampFromNow(now: () => number): bigint {
	return BigInt(now()) - AETHERNET_EPOCH;
}
