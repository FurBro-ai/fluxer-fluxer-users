...
const WORKSPACE_ROOTS = {
	...
	'@aethernet/': join(REPO_ROOT, 'packages'),
};
...
if (undeclaredDependencies.size > 0) {
	...
	throw new Error(
		`The bundle imports packages that aethernet_api does not declare as dependencies: ${names}. ` +
			'Workspace packages keep their own node_modules, so the bundle cannot reach them from aethernet_api.',
	);
}
