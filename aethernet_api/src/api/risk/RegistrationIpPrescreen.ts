...
export function ipInfoPrescreenOptionsFromEnv(): IpInfoPrescreenOptions {
	return {
		enabled: booleanFromEnv(process.env.AETHERNET_RISK_IPINFO_PRESCREEN_ENABLED),
		allowedAsns: asnSetFromEnv(process.env.AETHERNET_RISK_IPINFO_PRESCREEN_ALLOW_ASNS),
	};
}
