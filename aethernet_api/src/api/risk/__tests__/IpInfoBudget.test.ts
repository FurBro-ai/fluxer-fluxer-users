...
const BUDGET_ENV_KEYS = [
	'AETHERNET_IPINFO_BUDGET_ENABLED',
	'AETHERNET_IPINFO_BUDGET_MONTHLY_MAX',
	'AETHERNET_IPINFO_BUDGET_BACKGROUND_MONTHLY_PCT',
	'AETHERNET_IPINFO_BUDGET_STANDARD_MONTHLY_PCT',
	'AETHERNET_IPINFO_BUDGET_CRITICAL_BURST',
	'AETHERNET_IPINFO_BUDGET_STANDARD_BURST',
	'AETHERNET_IPINFO_BUDGET_BACKGROUND_BURST',
	'AETHERNET_IPINFO_BUDGET_CRITICAL_REFILL_PER_MIN',
	'AETHERNET_IPINFO_BUDGET_STANDARD_REFILL_PER_MIN',
	'AETHERNET_IPINFO_BUDGET_BACKGROUND_REFILL_PER_MIN',
];
...
describe('IpInfoBudget', () => {
	...
	beforeEach(() => {
		...
		process.env.AETHERNET_IPINFO_BUDGET_MONTHLY_MAX = '100';
	});
	...
	it('sheds once the per-priority burst bucket is drained', async () => {
		process.env.AETHERNET_IPINFO_BUDGET_BACKGROUND_BURST = '3';
		process.env.AETHERNET_IPINFO_BUDGET_BACKGROUND_REFILL_PER_MIN = '1';
		const kv = new MockKVProvider();
		const budget = createKvIpInfoLookupBudget({getKvClient: () => kv});
	...
	it('admits everything when the budget is disabled', async () => {
		process.env.AETHERNET_IPINFO_BUDGET_ENABLED = '0';
		const kv = new MockKVProvider();
