...
import type {AethernetSearchIndexName} from '@pkgs/elasticsearch_search/src/ElasticsearchIndexDefinitions';

export interface MeilisearchIndexDefinition {
	uid: AethernetSearchIndexName;
	primaryKey: string;
...
export const MEILISEARCH_INDEX_DEFINITIONS: Record<AethernetSearchIndexName, MeilisearchIndexDefinition> = {
	messages: {
		uid: 'messages',
		primaryKey: 'id',
