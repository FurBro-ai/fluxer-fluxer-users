...
import type {SearchResult as SchemaSearchResult} from '@aethernet/schema/src/contracts/search/SearchAdapterTypes';
import type {MessageSearchFilters, SearchableMessage} from '@aethernet/schema/src/contracts/search/SearchDocumentTypes';
import {
