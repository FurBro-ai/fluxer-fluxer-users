...
import type {SearchableGuildMember} from '@aethernet/schema/src/contracts/search/SearchDocumentTypes';
...
} from '@aethernet/schema/src/domains/guild/GuildMemberSearchSchemas';
