...
import type {GuildVanityURLResponse} from '@aethernet/schema/src/domains/guild/GuildResponseSchemas';
import {
	createInviteCode,
	createVanityURLCode,
	type GuildID,
...
export class GuildVanityService {
	...
	async updateVanityURL(
		...
		if (code?.includes('aethernet')) {
			throw InputValidationError.fromCode('code', ValidationErrorCodes.VANITY_URL_CODE_CANNOT_CONTAIN_AETHERNET);
		}
