...
import {MAX_GUILD_EXPRESSION_SLOTS_UNLIMITED, MAX_GUILD_STICKERS} from '@aethernet/constants/src/LimitConstants';
...
import {MaxGuildStickersStaticError} from '@aethernet/errors/src/domains/guild/MaxGuildStickersStaticError';
...
export class StickerService {
	...
	private getLocalizedBulkCreateError(error: unknown, locale: string | null | undefined): string {
		if (error instanceof AethernetError) {
