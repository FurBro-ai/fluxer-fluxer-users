...
import {MEDIA_PROXY_ICON_SIZE_DEFAULT} from '@aethernet/constants/src/MediaProxyAssetSizes';
import type {MediaProxyImageSize} from '@aethernet/constants/src/MediaProxyImageSizes';
