...
} from '@aethernet/schema/src/domains/admin/AdminArchiveSchemas';
import {
...
import {ArchivePathParam, GuildIdParam, UserIdParam} from '@aethernet/schema/src/domains/common/CommonParamSchemas';
