...
const RUST_SOURCE = fs.readFileSync(path.join(REPO_ROOT, 'aethernet_svc/src/postgres.rs'), 'utf8');
...
const SHARED_LITERALS = ['120s', '30min', '__aethernet_schema_migrations', 'messages_partition_key_v1'];
...
describe('Postgres KV schema parity between the API and aethernet_svc', () => {
	...
	it('never disables the statement timeout in aethernet_svc', () => {
