...
import type {CassandraParams, ColumnName, KvColumnParam, KvQueryMeta, PreparedQuery, WhereExpr} from './CassandraTypes';
import {isConditionalQuery, validateTtlSeconds} from './CassandraTypes';
...
const ENCODED_TYPE_KEY = '__aethernet_type';
...
export const POSTGRES_KV_MIGRATION_TABLE = '__aethernet_schema_migrations';
...
const NUMERIC_ROW_KEY_BIGINT_PATTERN = '^\\{"__aethernet_type":"bigint","value":"(-?[0-9]+)"\\}$';
