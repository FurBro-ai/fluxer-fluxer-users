...
import {extractClientIp} from '@aethernet/ip_utils/src/ClientIp';
import {getSameIpDecisionKey, isPublicIpAddress, parseIpAddress} from '@aethernet/ip_utils/src/IpAddress';
...
const WINDOW_MS = positiveNumberFromEnv('AETHERNET_ABUSE_WINDOW_MS', 60_000);
const THRESHOLD_DATACENTER = positiveNumberFromEnv('AETHERNET_ABUSE_THRESHOLD_DATACENTER', 20);
const THRESHOLD_ANONYMOUS = positiveNumberFromEnv('AETHERNET_ABUSE_THRESHOLD_ANONYMOUS', 500);
const THRESHOLD_MOBILE = positiveNumberFromEnv('AETHERNET_ABUSE_THRESHOLD_MOBILE', 1000);
const THRESHOLD_RESIDENTIAL = positiveNumberFromEnv('AETHERNET_ABUSE_THRESHOLD_RESIDENTIAL', 100);
const TOKEN_DIVERSITY_DATACENTER = positiveNumberFromEnv('AETHERNET_ABUSE_TOKEN_DIVERSITY_DATACENTER', 10);
const TOKEN_DIVERSITY_ANONYMOUS = positiveNumberFromEnv('AETHERNET_ABUSE_TOKEN_DIVERSITY_ANONYMOUS', 50);
const TOKEN_DIVERSITY_MOBILE = positiveNumberFromEnv('AETHERNET_ABUSE_TOKEN_DIVERSITY_MOBILE', 100);
const TOKEN_DIVERSITY_RESIDENTIAL = positiveNumberFromEnv('AETHERNET_ABUSE_TOKEN_DIVERSITY_RESIDENTIAL', 10);
const AUTO_BAN_TTL_SECONDS = positiveNumberFromEnv('AETHERNET_ABUSE_BAN_TTL_SEC', 86_400);
const BATCH_FLUSH_MS = positiveNumberFromEnv('AETHERNET_ABUSE_BATCH_FLUSH_MS', 500);
const MAX_BATCH_TICKS = positiveNumberFromEnv('AETHERNET_ABUSE_MAX_BATCH_TICKS', 5000);
const MAX_NEW_TOKENS_PER_TICK = positiveNumberFromEnv('AETHERNET_ABUSE_MAX_NEW_TOKENS_PER_TICK', 20);
const MAX_TRACKED_IPS = positiveNumberFromEnv('AETHERNET_ABUSE_MAX_TRACKED_IPS', 100_000);
const MAX_TOKEN_HASHES_PER_IP = positiveNumberFromEnv('AETHERNET_ABUSE_MAX_TOKEN_HASHES_PER_IP', 100);
const MIN_SCORE_FOR_IP_LOOKUP = positiveNumberFromEnv('AETHERNET_ABUSE_MIN_SCORE_FOR_LOOKUP', 20);
const MIN_TOKENS_FOR_IP_LOOKUP = positiveNumberFromEnv('AETHERNET_ABUSE_MIN_TOKENS_FOR_LOOKUP', 10);
const REQUIRED_SCORE_WINDOWS_FOR_AUTO_BAN = positiveNumberFromEnv(
	'AETHERNET_ABUSE_REQUIRED_SCORE_WINDOWS_FOR_AUTO_BAN',
	3,
);
...
const IP_CLASS_CLAIM_ENABLED = process.env.AETHERNET_ABUSE_IP_CLASS_CLAIM_ENABLED !== '0';
const IP_CLASS_CLAIM_TTL_SECONDS = positiveNumberFromEnv('AETHERNET_ABUSE_IP_CLASS_CLAIM_TTL_SEC', 15);
const DEFAULT_IP_CLASS_PENDING_TTL_MS = positiveNumberFromEnv('AETHERNET_ABUSE_IP_CLASS_PENDING_TTL_MS', 20_000);
const DEFAULT_IP_CLASS_NEGATIVE_TTL_MS = positiveNumberFromEnv('AETHERNET_ABUSE_IP_CLASS_NEGATIVE_TTL_MS', 300_000);
const DEFAULT_IP_CLASS_HINT_TTL_MS = positiveNumberFromEnv('AETHERNET_ABUSE_IP_CLASS_HINT_TTL_MS', 600_000);
