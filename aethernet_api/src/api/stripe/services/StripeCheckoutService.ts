...
import {isEuEeaCountryCode} from '@aethernet/constants/src/EuropeanEconomicArea';
import {PremiumFlags, UserPremiumTypes} from '@aethernet/constants/src/UserConstants';
import {PurchaseEmailVerificationRequiredError} from '@aethernet/errors/src/domains/auth/EmailVerificationRequiredError';
import {PremiumPurchaseBlockedError} from '@aethernet/errors/src/domains/payment/PremiumPurchaseBlockedError';
import {StripeError} from '@aethernet/errors/src/domains/payment/StripeError';
import {StripeInvalidProductConfigurationError} from '@aethernet/errors/src/domains/payment/StripeInvalidProductConfigurationError';
import {StripeInvalidProductError} from '@aethernet/errors/src/domains/payment/StripeInvalidProductError';
import {StripeNoPurchaseHistoryError} from '@aethernet/errors/src/domains/payment/StripeNoPurchaseHistoryError';
import {StripePaymentNotAvailableError} from '@aethernet/errors/src/domains/payment/StripePaymentNotAvailableError';
import {UnclaimedAccountCannotMakePurchasesError} from '@aethernet/errors/src/domains/user/UnclaimedAccountCannotMakePurchasesError';
import {UnknownUserError} from '@aethernet/errors/src/domains/user/UnknownUserError';
import type {CheckoutPaymentMethod} from '@aethernet/schema/src/domains/premium/GiftCodeSchemas';
...
const PRODUCT_NAME = 'Aethernet';
const PREMIUM_TIER_NAME = 'Plutonium';
const TERMS_URL = 'https://aethernet.app/terms';
...
const UPI_MANDATE_DESCRIPTION = 'Aethernet Premium';
