...
import {InvalidRequestError} from '@aethernet/errors/src/domains/core/InvalidRequestError';
import {InvalidTokenError} from '@aethernet/errors/src/domains/core/InvalidTokenError';
import {BotIsPrivateError} from '@aethernet/errors/src/domains/oauth/BotIsPrivateError';
import {InvalidClientError} from '@aethernet/errors/src/domains/oauth/InvalidClientError';
import {InvalidClientSecretError} from '@aethernet/errors/src/domains/oauth/InvalidClientSecretError';
import {InvalidGrantError} from '@aethernet/errors/src/domains/oauth/InvalidGrantError';
import {InvalidRedirectUriError} from '@aethernet/errors/src/domains/oauth/InvalidRedirectUriError';
import {InvalidScopeError} from '@aethernet/errors/src/domains/oauth/InvalidScopeError';
import {MissingClientSecretError} from '@aethernet/errors/src/domains/oauth/MissingClientSecretError';
import {MissingRedirectUriError} from '@aethernet/errors/src/domains/oauth/MissingRedirectUriError';
