...
import {canAuthorizeBotInvite, normalizeBotInvitePermissions} from '@aethernet/constants/src/BotPermissionUtils';
import {JoinSourceTypes} from '@aethernet/constants/src/GuildConstants';
...
import {InvalidPermissionsIntegerError} from '@aethernet/errors/src/domains/core/InvalidPermissionsIntegerError';
import {InvalidPermissionsNegativeError} from '@aethernet/errors/src/domains/core/InvalidPermissionsNegativeError';
import {InvalidTokenError} from '@aethernet/errors/src/domains/core/InvalidTokenError';
...
import {BotAlreadyInGuildError} from '@aethernet/errors/src/domains/oauth/BotAlreadyInGuildError';
import {BotUserNotFoundError} from '@aethernet/errors/src/domains/oauth/BotUserNotFoundError';
import {InvalidClientError} from '@aethernet/errors/src/domains/oauth/InvalidClientError';
import {InvalidGrantError} from '@aethernet/errors/src/domains/oauth/InvalidGrantError';
import {InvalidResponseTypeForNonBotError} from '@aethernet/errors/src/domains/oauth/InvalidResponseTypeForNonBotError';
import {MissingClientSecretError} from '@aethernet/errors/src/domains/oauth/MissingClientSecretError';
import {NotABotApplicationError} from '@aethernet/errors/src/domains/oauth/NotABotApplicationError';
import {RedirectUriRequiredForNonBotError} from '@aethernet/errors/src/domains/oauth/RedirectUriRequiredForNonBotError';
import {UnknownApplicationError} from '@aethernet/errors/src/domains/oauth/UnknownApplicationError';
import type {
	ApplicationResponse,
	...
	RevokeRequestForm,
	TokenRequest,
} from '@aethernet/schema/src/domains/oauth/OAuthSchemas';
