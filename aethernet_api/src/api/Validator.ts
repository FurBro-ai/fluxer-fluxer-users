...
import {isValidationErrorCode, ValidationErrorCodes} from '@aethernet/constants/src/ValidationErrorCodes';
import {
	InputValidationError,
	type LocalizedValidationError,
} from '@aethernet/errors/src/domains/core/InputValidationError';
import type {ValidationError} from '@aethernet/errors/src/domains/core/ValidationError';
import {schemaMetadata} from '@aethernet/schema/src/SchemaMetadata';
...
import {initializeAethernetErrorMap} from './ZodErrorMap';

initializeAethernetErrorMap();
