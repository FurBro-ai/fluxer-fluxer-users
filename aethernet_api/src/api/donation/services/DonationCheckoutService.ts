...
import {DonationAmountInvalidError} from '@aethernet/errors/src/domains/donation/DonationAmountInvalidError';
...
import {isDonationAmountWithinConstraints} from '@aethernet/schema/src/domains/donation/DonationAmountUtils';
import type {DonationCurrency} from '@aethernet/schema/src/domains/donation/DonationSchemas';
			...
			const lineItem: CheckoutSessionLineItem = isRecurring
				? {
						price_data: {
							...
							product_data: {
								name: 'AETHERNET Recurring Donation',
								description: `${params.interval === 'month' ? 'Monthly' : 'Yearly'} donation to support AETHERNET`,
							},
				...
				: {
						price_data: {
							currency: params.currency,
							product_data: {
								name: 'AETHERNET Donation',
								description: 'One-time donation to support AETHERNET',
							},
							unit_amount: params.amountCents,
						},
						quantity: 1,
