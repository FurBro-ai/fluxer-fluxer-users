	...
	app.get(
		...
		OpenAPI({
			...
			description: deprecated
				...
				: 'Searches the active GIF provider for GIFs matching the given query. The provider name is returned in the X-Aethernet-GIF-Provider response header so clients can adapt without refetching .well-known.',
		}),
