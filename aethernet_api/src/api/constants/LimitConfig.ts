...
import {DEFAULT_RESTRICTED_LIMITS, DEFAULT_STOCK_LIMITS} from '@aethernet/limits/src/LimitDefaults';
import type {LimitConfigSnapshot, LimitRule} from '@aethernet/limits/src/LimitTypes';
