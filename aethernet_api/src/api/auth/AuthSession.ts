...
import {BotUserAuthSessionCreationDeniedError} from '@aethernet/errors/src/domains/auth/BotUserAuthSessionCreationDeniedError';
import {RegistrationPendingApprovalError} from '@aethernet/errors/src/domains/auth/RegistrationPendingApprovalError';
import {RegistrationRejectedError} from '@aethernet/errors/src/domains/auth/RegistrationRejectedError';
import {SessionTokenMismatchError} from '@aethernet/errors/src/domains/auth/SessionTokenMismatchError';
...
import {requireClientIp} from '@aethernet/ip_utils/src/ClientIp';
import type {AuthSessionResponse} from '@aethernet/schema/src/domains/auth/AuthSchemas';
...
import {isAethernetNativeUserAgent, parseReportedClientOs} from '../utils/SessionClientIdentity';
...
export function resolveSessionOrigin(ctx: ApiContext, request: Request): SessionOrigin {
	...
	const clientOs = isAethernetNativeUserAgent(userAgent)
		? parseReportedClientOs(request.headers.get('x-aethernet-client-properties'))
		: null;
