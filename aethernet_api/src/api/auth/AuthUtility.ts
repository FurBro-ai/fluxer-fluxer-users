...
import {AccountPermanentlySuspendedError} from '@aethernet/errors/src/domains/user/AccountPermanentlySuspendedError';
import {AccountTemporarilySuspendedError} from '@aethernet/errors/src/domains/user/AccountTemporarilySuspendedError';
