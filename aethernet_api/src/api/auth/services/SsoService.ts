...
import {ProfileFieldPrivacyFlags} from '@aethernet/constants/src/UserConstants';
import {ValidationErrorCodes} from '@aethernet/constants/src/ValidationErrorCodes';
import {RegistrationClosedError} from '@aethernet/errors/src/domains/auth/RegistrationClosedError';
import {RegistrationPendingApprovalError} from '@aethernet/errors/src/domains/auth/RegistrationPendingApprovalError';
import {SsoRequiredError} from '@aethernet/errors/src/domains/auth/SsoRequiredError';
...
const MOBILE_SSO_REDIRECT_URI = 'aethernet://auth/sso/callback';
