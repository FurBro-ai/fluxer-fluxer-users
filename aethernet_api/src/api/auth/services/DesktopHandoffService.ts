...
import {HandoffCodeExpiredError} from '@aethernet/errors/src/domains/auth/HandoffCodeExpiredError';
import {InvalidHandoffCodeError} from '@aethernet/errors/src/domains/auth/InvalidHandoffCodeError';
import {
	DESKTOP_HANDOFF_CODE_ALPHABET,
	DESKTOP_HANDOFF_CODE_LENGTH,
	formatDesktopHandoffCode,
	parseDesktopHandoffCode,
} from '@aethernet/schema/src/domains/auth/DesktopHandoffCode';
