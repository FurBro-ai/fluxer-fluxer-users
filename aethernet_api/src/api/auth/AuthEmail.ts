...
import {SuspiciousActivityFlags, UserFlags} from '@aethernet/constants/src/UserConstants';
...
import type {VerifyEmailRequest} from '@aethernet/schema/src/domains/auth/AuthSchemas';
