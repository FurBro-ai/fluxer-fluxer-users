...
import {GUILD_TEXT_BASED_CHANNEL_TYPES, Permissions} from '@aethernet/constants/src/ChannelConstants';
import type {LimitKey} from '@aethernet/constants/src/LimitConfigMetadata';
import {MAX_WEBHOOKS_PER_CHANNEL, MAX_WEBHOOKS_PER_GUILD} from '@aethernet/constants/src/LimitConstants';
import {MaxWebhooksPerChannelError} from '@aethernet/errors/src/domains/channel/MaxWebhooksPerChannelError';
...
import {MaxWebhooksPerGuildError} from '@aethernet/errors/src/domains/guild/MaxWebhooksPerGuildError';
import {UnknownWebhookError} from '@aethernet/errors/src/domains/webhook/UnknownWebhookError';
import type {AllowedMentionsRequest} from '@aethernet/schema/src/domains/message/SharedMessageSchemas';
import type {GitHubWebhook} from '@aethernet/schema/src/domains/webhook/GitHubWebhookSchemas';
import type {InstatusWebhook} from '@aethernet/schema/src/domains/webhook/InstatusWebhookSchemas';
import type {
	WebhookCreateRequest,
	WebhookMessageRequest,
	WebhookTokenUpdateRequest,
	WebhookUpdateRequest,
} from '@aethernet/schema/src/domains/webhook/WebhookRequestSchemas';
...
const WEBHOOK_AVATAR_MISSING_CACHE_VALUE = '__aethernet_webhook_avatar_missing__';
