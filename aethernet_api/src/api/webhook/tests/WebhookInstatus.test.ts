...
function createInstatusPage() {
	return {
		...
		url: 'https://status.aethernet.app',
	};
}
...
function createInstatusMeta() {
	...
	return {unsubscribe: 'https://status.aethernet.app/unsubscribe?id=1&token=abc', documentation: ''};
}
...
function createInstatusIncident(overrides: Record<string, unknown> = {}) {
	return {
		...
		url: 'https://status.aethernet.app/incident/inc_1',
