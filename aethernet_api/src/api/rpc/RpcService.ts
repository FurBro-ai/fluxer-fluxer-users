...
import {AUTOMATIC_VOICE_REGION_ID, ChannelTypes, MessageTypes} from '@aethernet/constants/src/ChannelConstants';
import type {LimitKey} from '@aethernet/constants/src/LimitConfigMetadata';
import {MAX_PRIVATE_CHANNELS_PER_USER} from '@aethernet/constants/src/LimitConstants';
import {
...
import type {VoiceStateResponse} from '@aethernet/schema/src/domains/gateway/GatewaySchemas';
...
} from '@aethernet/schema/src/domains/rpc/RpcSchemas';
import type {RelationshipResponse} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
