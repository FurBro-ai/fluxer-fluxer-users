...
import {MessageFlags, Permissions, SENDABLE_MESSAGE_FLAGS} from '@aethernet/constants/src/ChannelConstants';
...
import type {RichEmbedRequest} from '@aethernet/schema/src/domains/message/MessageRequestSchemas';
