...
import {EmbedMediaFlags, MessageAttachmentFlags} from '@aethernet/constants/src/ChannelConstants';
import type {LimitKey} from '@aethernet/constants/src/LimitConfigMetadata';
import {MAX_FAVORITE_MEME_TAGS, MAX_FAVORITE_MEMES_NON_PREMIUM} from '@aethernet/constants/src/LimitConstants';
...
import {MaxFavoriteMemesError} from '@aethernet/errors/src/domains/core/MaxFavoriteMemesError';
import {MediaMetadataError} from '@aethernet/errors/src/domains/core/MediaMetadataError';
import {UnknownFavoriteMemeError} from '@aethernet/errors/src/domains/core/UnknownFavoriteMemeError';
import type {GifMediaFormat} from '@aethernet/schema/src/domains/gif/GifSchemas';
import {normalizeFilename} from '@aethernet/schema/src/primitives/FileValidators';
