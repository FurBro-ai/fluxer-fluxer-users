...
import {UnclaimedAccountCannotSubmitReportsError} from '@aethernet/errors/src/domains/moderation/UnclaimedAccountCannotSubmitReportsError';
import type {
	...
	ReportUserRequest,
	TicketResponse,
} from '@aethernet/schema/src/domains/report/ReportSchemas';
