...
import {InviteTypes, Permissions} from '@aethernet/constants/src/ChannelConstants';
import {GuildFeatures} from '@aethernet/constants/src/GuildConstants';
import {UserFlags} from '@aethernet/constants/src/UserConstants';
import {ValidationErrorCodes} from '@aethernet/constants/src/ValidationErrorCodes';
import {CannotReportOwnMessageError} from '@aethernet/errors/src/domains/channel/CannotReportOwnMessageError';
import {UnknownChannelError} from '@aethernet/errors/src/domains/channel/UnknownChannelError';
...
import {FeatureTemporarilyDisabledError} from '@aethernet/errors/src/domains/core/FeatureTemporarilyDisabledError';
...
import {CannotReportGuildError} from '@aethernet/errors/src/domains/guild/CannotReportGuildError';
import {CannotReportOwnGuildError} from '@aethernet/errors/src/domains/guild/CannotReportOwnGuildError';
import {UnknownGuildError} from '@aethernet/errors/src/domains/guild/UnknownGuildError';
import {UnknownInviteError} from '@aethernet/errors/src/domains/invite/UnknownInviteError';
import {CannotReportYourselfError} from '@aethernet/errors/src/domains/moderation/CannotReportYourselfError';
import {InvalidDsaReportTargetError} from '@aethernet/errors/src/domains/moderation/InvalidDsaReportTargetError';
import {InvalidDsaTicketError} from '@aethernet/errors/src/domains/moderation/InvalidDsaTicketError';
import {InvalidDsaVerificationCodeError} from '@aethernet/errors/src/domains/moderation/InvalidDsaVerificationCodeError';
import {ReportBannedError} from '@aethernet/errors/src/domains/moderation/ReportBannedError';
import {UnknownReportError} from '@aethernet/errors/src/domains/moderation/UnknownReportError';
import {UnknownUserError} from '@aethernet/errors/src/domains/user/UnknownUserError';
import type {DsaReportRequest} from '@aethernet/schema/src/domains/report/ReportSchemas';
import {SnowflakeType} from '@aethernet/schema/src/primitives/SchemaPrimitives';
import {snowflakeToDate} from '@aethernet/snowflake/src/Snowflake';
...
export class ReportService {
	...
	private async findUserByTag(tag: string): Promise<User> {
		const parsed = this.parseAethernetTag(tag);
		if (!parsed) {
			throw new InvalidDsaReportTargetError();
		}
	...
	private parseAethernetTag(tag: string): {
		username: string;
