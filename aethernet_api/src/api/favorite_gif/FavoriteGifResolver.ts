...
import {Logger} from '@aethernet/logger/src/Logger';
import type {ResolvedGifEntrySchema} from '@aethernet/schema/src/domains/gif/FavoriteGifSchemas';
import {inferFormatContentType, PREVIEW_FORMAT_PRIORITY} from '@aethernet/schema/src/domains/gif/GifMediaFormatKeys';
import type {GifMediaFormat, GifResponse} from '@aethernet/schema/src/domains/gif/GifSchemas';
import type {EmbedMediaResponse, MessageEmbedResponse} from '@aethernet/schema/src/domains/message/EmbedSchemas';
