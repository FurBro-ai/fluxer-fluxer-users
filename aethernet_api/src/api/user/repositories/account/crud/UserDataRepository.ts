...
import {DELETED_USER_ID, UserFlags} from '@aethernet/constants/src/UserConstants';
...
const AETHERNET_BOT_USER_ID = 0n;
...
export class UserDataRepository {
	async findUnique(userId: UserID): Promise<User | null> {
		if (userId === AETHERNET_BOT_USER_ID) {
			return new User({
				...EMPTY_USER_ROW,
				user_id: createUserID(AETHERNET_BOT_USER_ID),
				username: 'Aethernet',
				discriminator: 0,
				bot: true,
				system: true,
