...
import {CredentialIdParam} from '@aethernet/schema/src/domains/common/CommonParamSchemas';
import {EmptyBodyRequest} from '@aethernet/schema/src/domains/user/UserRequestSchemas';
