...
import {MAX_RELATIONSHIPS} from '@aethernet/constants/src/LimitConstants';
import {RelationshipTypes, UserFlags} from '@aethernet/constants/src/UserConstants';
import {DirectMessagesDisabledError} from '@aethernet/errors/src/domains/channel/DirectMessagesDisabledError';
import {BotsCannotSendFriendRequestsError} from '@aethernet/errors/src/domains/oauth/BotsCannotSendFriendRequestsError';
import {AlreadyFriendsError} from '@aethernet/errors/src/domains/user/AlreadyFriendsError';
import {CannotBlockSystemUserError} from '@aethernet/errors/src/domains/user/CannotBlockSystemUserError';
import {CannotSendFriendRequestToBlockedUserError} from '@aethernet/errors/src/domains/user/CannotSendFriendRequestToBlockedUserError';
import {CannotSendFriendRequestToSelfError} from '@aethernet/errors/src/domains/user/CannotSendFriendRequestToSelfError';
import {FriendRequestBlockedError} from '@aethernet/errors/src/domains/user/FriendRequestBlockedError';
import {InvalidDiscriminatorError} from '@aethernet/errors/src/domains/user/InvalidDiscriminatorError';
import {MaxRelationshipsError} from '@aethernet/errors/src/domains/user/MaxRelationshipsError';
import {NoUsersWithAethernettagError} from '@aethernet/errors/src/domains/user/NoUsersWithAethernettagError';
import {UnclaimedAccountCannotAcceptFriendRequestsError} from '@aethernet/errors/src/domains/user/UnclaimedAccountCannotAcceptFriendRequestsError';
import {UnclaimedAccountCannotSendFriendRequestsError} from '@aethernet/errors/src/domains/user/UnclaimedAccountCannotSendFriendRequestsError';
...
} from '@aethernet/schema/src/domains/user/UserRequestSchemas';
...
export class UserRelationshipService {
	...
	async sendFriendRequestByTag({
		...
		if (!targetUser) {
			throw new NoUsersWithAethernettagError();
		}
