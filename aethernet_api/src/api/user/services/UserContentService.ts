...
import {MAX_BOOKMARKS_NON_PREMIUM} from '@aethernet/constants/src/LimitConstants';
...
import {MaxBookmarksError} from '@aethernet/errors/src/domains/core/MaxBookmarksError';
...
import {HarvestExpiredError} from '@aethernet/errors/src/domains/moderation/HarvestExpiredError';
import {HarvestFailedError} from '@aethernet/errors/src/domains/moderation/HarvestFailedError';
import {HarvestNotReadyError} from '@aethernet/errors/src/domains/moderation/HarvestNotReadyError';
import {NsfwContentRequiresAgeVerificationError} from '@aethernet/errors/src/domains/moderation/NsfwContentRequiresAgeVerificationError';
import {UnknownHarvestError} from '@aethernet/errors/src/domains/moderation/UnknownHarvestError';
import {UnknownUserError} from '@aethernet/errors/src/domains/user/UnknownUserError';
import type {MessageResponse} from '@aethernet/schema/src/domains/message/MessageResponseSchemas';
import type {
	HarvestCreationResponse,
	HarvestStatusResponse,
} from '@aethernet/schema/src/domains/user/UserHarvestSchemas';
import type {
...
import type {SavedMessageStatus} from '@aethernet/schema/src/domains/user/UserResponseSchemas';
...
export class UserContentService {
	...
	async streamHarvestDownload(params: {
		...
		return {
			...
			filename: `aethernet-data-${params.harvestId}.zip`,
		};
	}
