...
import {UserOwnsGuildsError} from '@aethernet/errors/src/domains/guild/UserOwnsGuildsError';
import {PhoneGateEscapeUnavailableError} from '@aethernet/errors/src/domains/user/PhoneGateEscapeUnavailableError';
