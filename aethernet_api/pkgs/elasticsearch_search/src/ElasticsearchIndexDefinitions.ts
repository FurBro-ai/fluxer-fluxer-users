...
export type AethernetSearchIndexName = 'messages' | 'guilds' | 'users' | 'reports' | 'audit_logs' | 'guild_members';
...
export interface ElasticsearchIndexDefinition {
	indexName: AethernetSearchIndexName;
	mappings: {
...
export const ELASTICSEARCH_INDEX_DEFINITIONS: Record<AethernetSearchIndexName, ElasticsearchIndexDefinition> = {
	messages: {
		indexName: 'messages',
		mappings: {
			properties: {
