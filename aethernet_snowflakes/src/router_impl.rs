...
use aethernet_svc::hash_ring::HashRing;
use aethernet_svc::metrics::ServiceMetrics;
use aethernet_svc::transport::{NatsMessage, NatsTransport, TransportMessage, TransportSubscriber};
use std::sync::Arc;
...
pub async fn run_round_robin_router(
    ...
    tokio::select! {
        ...
        _ = aethernet_svc::shutdown::wait_for_shutdown() => {
