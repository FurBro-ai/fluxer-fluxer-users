...
use aethernet_common::user_flags::{USER_FLAG_STAFF, visible_user_flags};
use aethernet_svc::shard::ShardService;
use aethernet_svc::transport::Transport;
use aethernet_svc::{postgres, postgres::BigIntBound, postgres::KeyPart};
...
const AETHERNET_EPOCH_MS: i64 = 1_420_070_400_000;
...
const AETHERNET_SYSTEM_USER_ID: i64 = 0;
const AETHERNET_SYSTEM_USERNAME: &str = "Aethernet";
const AETHERNET_SYSTEM_DISCRIMINATOR: &str = "0000";
...
fn snowflake_to_epoch_millis(snowflake: i64) -> i64 {
    (snowflake >> 22) + AETHERNET_EPOCH_MS
}

fn epoch_millis_to_bucket(epoch_millis: i64) -> i32 {
    ((epoch_millis - AETHERNET_EPOCH_MS) / BUCKET_DURATION_MS) as i32
}
...
fn map_user_partial(partial: UserPartialServiceResponse) -> ApiUserPartialResponse {
    if partial.user_id == AETHERNET_SYSTEM_USER_ID {
        return aethernet_system_user();
    }
...
fn aethernet_system_user() -> ApiUserPartialResponse {
    ApiUserPartialResponse {
        id: AETHERNET_SYSTEM_USER_ID.to_string(),
        username: AETHERNET_SYSTEM_USERNAME.to_owned(),
        discriminator: AETHERNET_SYSTEM_DISCRIMINATOR.to_owned(),
        global_name: None,
        avatar: None,
        avatar_color: None,
        bot: Some(true),
...
fn deleted_user(user_id: i64) -> ApiUserPartialResponse {
    if user_id == AETHERNET_SYSTEM_USER_ID {
        return aethernet_system_user();
    }
    ApiUserPartialResponse {
...
fn external_media_proxy_url(input_url: &str, options: &ResponseBuildOptions) -> String {
    ...
    aethernet_common::external_media_path::build_external_media_proxy_url(
...
mod tests {
    use super::*;
    use aethernet_svc::transport::{InMemoryTransport, TransportSubscriber, reply_message};
    use serde_json::json;

    #[test]
    fn id_zero_is_always_aethernet_system_user() {
        ...
        assert_eq!(mapped.username, "Aethernet");
    ...
    #[test]
    fn missing_id_zero_fallback_is_aethernet_system_user() {
    ...
    fn postgres_message_decoder_maps_tagged_kv_payload() {
        let message = decode_postgres_message(json!({
            "channel_id": {"__aethernet_type": "bigint", "value": "1497639278555484216"},
            "bucket": 416,
            "message_id": {"__aethernet_type": "bigint", "value": "1509197195776110592"},
            "author_id": {"__aethernet_type": "bigint", "value": "1472426752046002208"},
            "type": null,
            "content": "hello",
            "edited_timestamp": {"__aethernet_type": "date", "value": "2026-06-15T12:34:56.789Z"},
            "pinned_timestamp": {"__aethernet_type": "date", "value": "2026-06-15T12:35:00.000Z"},
            "mention_users": {"__aethernet_type": "set", "value": [
                {"__aethernet_type": "bigint", "value": "1472426752046002208"}
            ]},
            "mention_roles": {"__aethernet_type": "set", "value": []},
            "mention_channels": {"__aethernet_type": "set", "value": []},
            "attachments": [{
                "attachment_id": {"__aethernet_type": "bigint", "value": "1509197195776110593"},
                "filename": "a.png",
                "size": {"__aethernet_type": "bigint", "value": "12345"},
                "content_type": "image/png",
                "flags": 0
            }],
            "call": {
                "participant_ids": {"__aethernet_type": "set", "value": [
                    {"__aethernet_type": "bigint", "value": "1472426752046002208"}
                ]},
                "ended_timestamp": {"__aethernet_type": "date", "value": "2026-06-15T12:36:00.000Z"}
            },
            "version": null
        }))
        .unwrap();
    ...
    fn postgres_reaction_decoder_maps_created_at() {
        let (message_id, reaction) = decode_postgres_reaction(json!({
            "message_id": {"__aethernet_type": "bigint", "value": "1509197195776110592"},
            "user_id": {"__aethernet_type": "bigint", "value": "1472426752046002208"},
            "emoji_id": {"__aethernet_type": "bigint", "value": "0"},
            "emoji_name": "wave",
            "emoji_animated": false,
            "created_at": {"__aethernet_type": "date", "value": "2026-06-15T12:34:56.789Z"}
        }))
        .unwrap();
    ...
    fn response_context_id_collection_spans_referenced_messages() {
        let message = decode_postgres_message(json!({
            "channel_id": {"__aethernet_type": "bigint", "value": "10"},
            "bucket": 416,
            "message_id": {"__aethernet_type": "bigint", "value": "100"},
            "author_id": {"__aethernet_type": "bigint", "value": "1"},
            "content": "hey <@2> over in <#20>",
            "mention_users": {"__aethernet_type": "set", "value": [
                {"__aethernet_type": "bigint", "value": "2"}
            ]},
            "mention_channels": {"__aethernet_type": "set", "value": [
                {"__aethernet_type": "bigint", "value": "20"}
            ]},
            "attachments": [{
                "attachment_id": {"__aethernet_type": "bigint", "value": "1000"},
                "filename": "a.png"
            }]
        }))
        .unwrap();
        let referenced = decode_postgres_message(json!({
            "channel_id": {"__aethernet_type": "bigint", "value": "10"},
            "bucket": 416,
            "message_id": {"__aethernet_type": "bigint", "value": "99"},
            "author_id": {"__aethernet_type": "bigint", "value": "3"},
            "content": "look at <#21>",
            "mention_channels": {"__aethernet_type": "set", "value": [
                {"__aethernet_type": "bigint", "value": "21"}
            ]},
            "attachments": [{
                "attachment_id": {"__aethernet_type": "bigint", "value": "1001"},
                "filename": "b.png"
            }]
        }))
        .unwrap();
    ...
    fn orphaned_message(message_id: i64) -> Message {
        decode_postgres_message(json!({
            "channel_id": {"__aethernet_type": "bigint", "value": "10"},
            "bucket": 416,
            "message_id": {"__aethernet_type": "bigint", "value": message_id.to_string()},
            "content": "orphan"
        }))
        .unwrap()
    }
    ...
    fn webhook_message(message_id: i64) -> Message {
        decode_postgres_message(json!({
            ...
            "bucket": 416,
            "message_id": {"__aethernet_type": "bigint", "value": message_id.to_string()},
            "webhook_id": {"__aethernet_type": "bigint", "value": "77"},
            "webhook_name": "hook",
            "content": "kept"
        }))
        .unwrap()
