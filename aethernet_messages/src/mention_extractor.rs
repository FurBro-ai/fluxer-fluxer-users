...
use aethernet_markdown_parser::ast::{ListItem, MentionKind};
use aethernet_markdown_parser::{EmojiContext, MarkdownParser, Node, ParserFlags};
...
mod tests {
    ...
    const MENTION_CORPUS: &[&str] = &[
        ...
        "check out https://github.com/aethernetapp/aethernet/pull/1234 when you get a sec",
