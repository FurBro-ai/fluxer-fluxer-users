...
const REMOTE_IDENTITY_DOMAIN: &[u8] = b"aethernet.media-proxy.source-object.remote";
const LOCAL_IDENTITY_DOMAIN: &[u8] = b"aethernet.media-proxy.source-object.local";
