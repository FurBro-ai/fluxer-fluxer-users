...
async fn head_object_leaves_the_storage_counters_untouched() {
    ...
    assert_eq!(
        0,
        rendered_counter(&metrics, "aethernet_media_proxy_storage_hits_total")
    );
    assert_eq!(
        0,
        rendered_counter(&metrics, "aethernet_media_proxy_storage_misses_total")
    );
    assert_eq!(
        0,
        rendered_counter(&metrics, "aethernet_media_proxy_storage_errors_total")
    );
