...
const NATIVE_INSTALLER_HASH: &str = "hashFiles('aethernet_media_proxy/tools/install-native-deps.sh')";
...
fn the_installer_requires_the_bmp_decoder_libvips_can_no_longer_provide() {
    ...
    let allowed = shim_string_macro(&header, "AETHERNET_ALLOWED_VIDEO_DECODERS");
    assert!(
