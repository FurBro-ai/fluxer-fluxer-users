...
A person MUST NOT publicly accuse or harass a contributor because of suspected LLM use. All discussion, review and enforcement under this policy MUST comply with the [Code of Conduct](https://github.com/aethernetapp/aethernet/blob/main/.github/CODE_OF_CONDUCT.md).
