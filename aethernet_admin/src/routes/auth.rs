...
const OAUTH_FLOW_STORAGE_KEY: &str = "aethernet-admin-oauth-flow";
const OAUTH_FINISH_HEADER: &str = "x-aethernet-admin-oauth";
...
fn verifier_hash_bytes(verifier: &str) -> [u8; OAUTH_STATE_VERIFIER_HASH_BYTES] {
    ...
    hasher.update(b"aethernet-admin-oauth-verifier:");
...
fn sign_oauth_state_payload(secret_key: &str, payload: &str) -> String {
    ...
    mac.update(b"aethernet-admin-oauth-state:");
