...
fn deserialize_admin_users_me_response() {
    let json = r#"{
        "user": {
            ...
            "avatar": "563de430",
            "banner": "bd221c57",
            "bio": "For support, please contact support@aethernet.app.",
            "pronouns": "he/him",
            "accent_color": 2631308,
            "email": "hampus@aethernet.com",
            "email_verified": true,
            "email_bounced": false,
...
fn deserialize_search_guilds_response() {
    ...
    assert_eq!(resp.guilds[0].name, "Aethernet Testers");
